...
begin
  update imp_file set row = p_record where id = p_record.id;
end;
...
begin
  update org_attr set row = p_record where id = p_record.id;
end;


procedure org_attr_val_t(p_record in out org_attr_val%rowtype) is
begin
  update org_attr_val set row = p_record where id = p_record.id;
end;
...
begin
  update tr_parcel_event set row = p_record where id = p_record.id;
end;


procedure tr_parcel_event_type_t(p_record in out tr_parcel_event_type%rowtype) is
begin
  update tr_parcel_event_type set row = p_record where id = p_record.id;
end;


procedure tr_parcel_event_type_grp_t(p_record in out tr_parcel_event_type_grp%rowtype) is
begin
  update tr_parcel_event_type_grp set row = p_record where code = p_record.code;
end;


procedure tr_parcel_reject_reason_t(p_record in out tr_parcel_reject_reason%rowtype) is
begin
  update tr_parcel_reject_reason set row = p_record where id = p_record.id;
end;
