...
prompt Creating foreign key FK_ORGATTRVAL_ORG on table ORG_ATTR_VAL ...
ALTER TABLE ORG_ATTR_VAL ADD CONSTRAINT FK_ORGATTRVAL_ORG FOREIGN KEY (ORG_ID) REFERENCES ORGANIZATION(ID) on delete CASCADE;

prompt Creating foreign key FK_ORGATTRVAL_ORGATTR on table ORG_ATTR_VAL ...
ALTER TABLE ORG_ATTR_VAL ADD CONSTRAINT FK_ORGATTRVAL_ORGATTR FOREIGN KEY (ORGATTR_ID) REFERENCES ORG_ATTR(ID);
...
prompt Creating foreign key FK_PARCEL_ORG on table TR_PARCEL ...
ALTER TABLE TR_PARCEL ADD CONSTRAINT FK_PARCEL_ORG FOREIGN KEY (CUSTODY_ORG_ID) REFERENCES ORGANIZATION(ID);

prompt Creating foreign key FK_PARCEL_PRODUCT on table TR_PARCEL ...
ALTER TABLE TR_PARCEL ADD CONSTRAINT FK_PARCEL_PRODUCT FOREIGN KEY (PRODUCT_ID) REFERENCES MM_PRODUCT(ID);

prompt Creating foreign key FK_PARCELEVNT_EVNTTYP on table TR_PARCEL_EVENT ...
ALTER TABLE TR_PARCEL_EVENT ADD CONSTRAINT FK_PARCELEVNT_EVNTTYP FOREIGN KEY (EVENTTYP_ID) REFERENCES TR_PARCEL_EVENT_TYPE(ID);

prompt Creating foreign key FK_PARCELEVNT_ORG_1 on table TR_PARCEL_EVENT ...
ALTER TABLE TR_PARCEL_EVENT ADD CONSTRAINT FK_PARCELEVNT_ORG_1 FOREIGN KEY (SRC_ORG_ID) REFERENCES ORGANIZATION(ID);

prompt Creating foreign key FK_PARCELEVNT_ORG_2 on table TR_PARCEL_EVENT ...
ALTER TABLE TR_PARCEL_EVENT ADD CONSTRAINT FK_PARCELEVNT_ORG_2 FOREIGN KEY (DEST_ORG_ID) REFERENCES ORGANIZATION(ID);

prompt Creating foreign key FK_PARCELEVNT_PARCEL on table TR_PARCEL_EVENT ...
ALTER TABLE TR_PARCEL_EVENT ADD CONSTRAINT FK_PARCELEVNT_PARCEL FOREIGN KEY (PARCEL_ID) REFERENCES TR_PARCEL(ID);
