...
public class LOV0032 extends AbstractDataControl implements IDataControlLov {
...
private void preQuery() {
  ...
  public void doQuery() throws Exception {
      ...
      String sql = "select tsql.* from (select code from project_issue_status order by 1) tsql " + this.queryWhere.toString() + " " + this.queryOrderBy;
