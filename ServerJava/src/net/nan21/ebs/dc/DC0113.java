...
private void callProc_doAllocate() throws Exception {
  ...
  String sql = "BEGIN pbo_parcel.allocate_to_agent(p_warehouse_id => :p_warehouse_id,p_event_date => :p_event_date,p_raise => :p_raise,p_parcel_code => :p_parcel_code,p_agent_id => :p_agent_id); END;";
