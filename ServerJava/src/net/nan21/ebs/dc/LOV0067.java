...
public class LOV0067 extends AbstractDataControl implements IDataControlLov {
...
private void preQuery() {
  ...
  public void doQuery() throws Exception {
      ...
      String sql = "select tsql.* from (select t.id, t.name "+"  from organization t "+" where t.id in (select tt.org_id from org_attr_val tt where tt.orgattr_id = pbo_org.get_orgattr_id_by_name('IS_DELIVERY_AGENT')"+" and tt.attr_val = 'Y')"+") tsql " + this.queryWhere.toString() + " " + this.queryOrderBy;
