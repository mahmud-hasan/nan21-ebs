...
public class LOV0044 extends AbstractDataControl implements IDataControlLov {
...
private void preQuery() {
  ...
  public void doQuery() throws Exception {
      ...
      String sql = "select tsql.* from (select code from languages where active = 'Y' order by 1) tsql " + this.queryWhere.toString() + " " + this.queryOrderBy;
