...
public void doQuery() throws Exception {
    ...
    String sql = "select "+ 
               " ACTUAL_EFFORT"+
               " ,to_char(ACT_ENDDATE,'"+this.DATE_FORMAT_DB+"') ACT_ENDDATE"+
               " ,to_char(ACT_STARTDATE,'"+this.DATE_FORMAT_DB+"') ACT_STARTDATE"+
               " ,AFF_CMP"+
               " ,AFF_CMP_TYPE_CODE"+
               ...
               " ,to_char(PLAN_ENDDATE,'"+this.DATE_FORMAT_DB+"') PLAN_ENDDATE"+
               " ,to_char(PLAN_STARTDATE,'"+this.DATE_FORMAT_DB+"') PLAN_STARTDATE"+
               " ,PRIORITY_CODE"+
               " ,PROJECT_ID"+
