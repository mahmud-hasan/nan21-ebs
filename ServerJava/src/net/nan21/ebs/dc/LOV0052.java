...
public class LOV0052 extends AbstractDataControl implements IDataControlLov {
...
private void preQuery() {
  ...
  public void doQuery() throws Exception {
      ...
      String sql = "select tsql.* from (select code from mm_org_inv_type t order by 1) tsql " + this.queryWhere.toString() + " " + this.queryOrderBy;
