...
public class LOV0065 extends AbstractDataControl implements IDataControlLov {
...
private void preQuery() {
  ...
  public void doQuery() throws Exception {
      ...
      String sql = "select tsql.* from (select code from TR_PARCEL_REJECT_REASON order by 1) tsql " + this.queryWhere.toString() + " " + this.queryOrderBy;
