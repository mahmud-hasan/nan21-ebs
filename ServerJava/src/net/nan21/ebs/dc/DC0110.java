 ...
 * Generated content.
 * DC0110 DC Controller: Parcel return reasons
 */
...
public class DC0110 extends AbstractDataControl implements IDataControl {
...
public void doQuery() throws Exception {
    ...
    String sql = "select "+ 
               ...
               " ,t.NAME"+
           " from TR_PARCEL_REJECT_REASON t "+this.queryWhere.toString()+" "+this.queryOrderBy;
...
public void doInsert()  throws Exception {
  ...
  this.populateRecordWithClientSpecific();
    String sql = "insert into TR_PARCEL_REJECT_REASON("+
               "  ACTIVE"+
               " ,CODE"+
               " ,ID"+
               " ,NAME"+
           " ) values ( "+
               ...
               " ,:NAME"+
    ")";
    this.record.put("ID",   dbm.getSequenceNextValue("SEQ_PARCELREJRES_ID")  );
...
public void doUpdate()  throws Exception {
    this.populateRecordFromRequest();
    this.populateRecordWithClientSpecific();
    String sql = "update TR_PARCEL_REJECT_REASON set "+
               "  ACTIVE=:ACTIVE"+ 
               " ,CREATEDBY=:CREATEDBY"+ 
               " ,CREATEDON=:CREATEDON"+ 
               " ,ID=:ID"+ 
...
public void doDelete() throws Exception {
    this.populateRecordPkFromRequest();
   String sql = "delete from TR_PARCEL_REJECT_REASON where "+
     "      ID= :ID"+
    "";
