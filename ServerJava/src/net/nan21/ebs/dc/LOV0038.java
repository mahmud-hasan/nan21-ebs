...
public class LOV0038 extends AbstractDataControl implements IDataControlLov {
...
private void preQuery() {
  ...
  public void doQuery() throws Exception {
      ...
      String sql = "select tsql.* from (select CODE from COMMUNIC_TYPE order by 1) tsql " + this.queryWhere.toString() + " " + this.queryOrderBy;
