...
public class LOV0016 extends AbstractDataControl implements IDataControlLov {
...
private void preQuery() {
  ...
  public void doQuery() throws Exception {
      ...
      String sql = "select tsql.* from (select code,name from delivery_Agent order by 1) tsql " + this.queryWhere.toString() + " " + this.queryOrderBy;
