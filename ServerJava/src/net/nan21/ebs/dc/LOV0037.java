...
public class LOV0037 extends AbstractDataControl implements IDataControlLov {
...
private void preQuery() {
  ...
  public void doQuery() throws Exception {
      ...
      String sql = "select tsql.* from (select code from uom where is_period = 'Y' order by 1) tsql " + this.queryWhere.toString() + " " + this.queryOrderBy;
