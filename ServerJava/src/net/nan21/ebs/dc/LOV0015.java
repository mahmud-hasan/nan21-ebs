...
public class LOV0015 extends AbstractDataControl implements IDataControlLov {
...
private void preQuery() {
  ...
  public void doQuery() throws Exception {
      ...
      String sql = "select tsql.* from (select code, name from rinv_doc_type t where active= 'Y') tsql " + this.queryWhere.toString() + " " + this.queryOrderBy;
