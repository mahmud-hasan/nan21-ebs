...
public class LOV0023 extends AbstractDataControl implements IDataControlLov {
...
private void preQuery() {
  ...
  public void doQuery() throws Exception {
      ...
      String sql = "select tsql.* from (select id, name from ac_acc_period  where client_id = :p_client_id order by startdate) tsql " + this.queryWhere.toString() + " " + this.queryOrderBy;
