  ...
  DC0113 = new N21.DataComp.DC0113({id:"DC0113", autoScroll:true });
  var gui = new Ext.Viewport({
    ...
    ,{ region: "north",border: false, html:"<div class='gui_title'>"+(N21.DataComp.DC0113.prototype.resourceBundle.DcProperty.Title||"Allocate to agent")+" &nbsp;&nbsp;&nbsp;<font size=-2>&lt;UI0111&gt;</div>"}
   ]
});
  });
