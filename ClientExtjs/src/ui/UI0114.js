  ...
  DC0117 = new N21.DataComp.DC0117({id:"DC0117", autoScroll:true });
  var gui = new Ext.Viewport({
    ...
    ,{ region: "north",border: false, html:"<div class='gui_title'>"+(N21.DataComp.DC0117.prototype.resourceBundle.DcProperty.Title||"Reception new")+" &nbsp;&nbsp;&nbsp;<font size=-2>&lt;UI0114&gt;</div>"}
   ]
});
  });
