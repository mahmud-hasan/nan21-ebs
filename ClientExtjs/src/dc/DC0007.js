    ...
    ,initComponent:function() {
       Ext.apply(this, {
           store: new Ext.data.JsonStore({
              ...
              ,root:"records"
              ,url:CFG_BACKENDSERVER_URL+"?_p_action=fetch&_p_data_format=json&_p_form=DC0007"
              ,remoteSort :true
...
,"->","<span class='dcName'>DC0007</span>"          )
          ,dataComponentName:"DC0007"
          ,frame:true
          ,queryArraySize:20
          ,childDCs: [{name:"DC0008",relation:[{parent:"CODE",child:"COUNTRY_CODE"}]}]
          ,buttons: [{xtype:"button",scope:this,text:"Regions",handler:function() {this.show_window("DC0008");}}]
        });
    ...
    this.colModel = new Ext.grid.ColumnModel (this.columnMap.getRange());
       ...
       this.queryFields.add("ID",new Ext.form.Hidden({name:"QRY_ID",id:"DC0007F_QRY_ID",fieldLabel: this.resourceBundle.FieldLabel.ID||"Id",allowBlank:true,width:100}));
       this.queryFields.add("CODE",new Ext.form.TextField({name:"QRY_CODE",id:"DC0007F_QRY_CODE",fieldLabel: this.resourceBundle.FieldLabel.CODE||"Code",allowBlank:true,caseRestriction:"Upper",style: "text-transform:uppercase;",width:100}));
       this.queryFields.add("NAME",new Ext.form.TextField({name:"QRY_NAME",id:"DC0007F_QRY_NAME",fieldLabel: this.resourceBundle.FieldLabel.NAME||"Name",allowBlank:true,width:100}));

       this.layoutItems.add("DC0008",
             new Ext.Window({ xtype:"window", modal:true, title: "DC0008 - "+(N21.DataComp.DC0008.prototype.resourceBundle.DcProperty.Title||"WINDOW"),  closeAction:"hide",closable:true,layout:"fit", width:600, height:400, items:{xtype:"DC0008",id:"DC0008", parentDcRelation:{name:"DC0007",relation:[{parent:"CODE",child:"COUNTRY_CODE"}]}         }} ) ); 
