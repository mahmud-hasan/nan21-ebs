 ...
 */ 
  ...
  N21.DataComp.DC0023G = Ext.extend(N21.Base.GridView, {
    ...
    ,initComponent:function() {
       ...
       this.queryFields.add("OPENED",new Ext.form.ComboBox({name:"QRY_OPENED",id:"DC0023F_QRY_OPENED",fieldLabel: this.resourceBundle.FieldLabel.OPENED||"Opened",allowBlank:true,width:40,store:["%","Y","N"],value:"%"}));
       this.queryFields.add("CLOSED",new Ext.form.ComboBox({name:"QRY_CLOSED",id:"DC0023F_QRY_CLOSED",fieldLabel: this.resourceBundle.FieldLabel.CLOSED||"Closed",allowBlank:true,width:40,store:["%","Y","N"],value:"%"}));
       ...
       Ext.apply(this, {
           store: new Ext.data.JsonStore({
              ...
              ,root:"records"
              ,url:CFG_BACKENDSERVER_URL+"?_p_action=fetch&_p_data_format=json&_p_form=DC0023"
              ,remoteSort :true
 ...
 */ 
  ...
  N21.DataComp.DC0023F = Ext.extend(N21.Base.EditForm, {
    ...
    ,initComponent:function() {
       ...
       this.fields.add("OPENED",new Ext.ux.form.XCheckbox({name:"OPENED",id:"DC0023F_OPENED",dataIndex:"OPENED",fieldLabel: this.resourceBundle.FieldLabel.OPENED||"Opened",allowBlank:true,insert_allowed:false,update_allowed:false}));
       this.fields.add("CLOSED",new Ext.ux.form.XCheckbox({name:"CLOSED",id:"DC0023F_CLOSED",dataIndex:"CLOSED",fieldLabel: this.resourceBundle.FieldLabel.CLOSED||"Closed",allowBlank:true,insert_allowed:false,update_allowed:false}));
       ...
       this.fields.add("IS_FIRST_YEAR",new Ext.ux.form.XCheckbox({name:"IS_FIRST_YEAR",id:"DC0023F_IS_FIRST_YEAR",dataIndex:"IS_FIRST_YEAR",fieldLabel: this.resourceBundle.FieldLabel.IS_FIRST_YEAR||"Is first year?",allowBlank:true,insert_allowed:true,update_allowed:true}));
  ...
  N21.DataComp.DC0023 = Ext.extend(N21.Base.GridEditForm, {
     ...
     initComponent:function() {
       Ext.apply(this, {
          ...
          ,border: false
          ,items: [
              {xtype: "DC0023G",id: "DC0023G",region:"west"  ,split:true,width:450,minWidth:0}
