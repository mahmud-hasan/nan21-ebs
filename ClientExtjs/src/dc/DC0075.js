 ...
 * Generated content.
 * DC0075 DataControl: Price levels
 */

  Ext.ns("N21.DataComp");
  N21.DataComp.DC0075 = Ext.extend(N21.Base.GridEdit, {
    ...
    ,initComponent:function() {
       Ext.apply(this, {
           store: new Ext.data.JsonStore({
              ...
              ,root:"records"
              ,url:CFG_BACKENDSERVER_URL+"?_p_action=fetch&_p_data_format=json&_p_form=DC0075"
              ,remoteSort :true
...
,"->","<span class='dcName'>DC0075</span>"          )
          ,dataComponentName:"DC0075"
          ,frame:true
          ,queryArraySize:20
        });
    ...
    this.colModel = new Ext.grid.ColumnModel (this.columnMap.getRange());
       ...
       this.queryFields.add("ID",new Ext.form.Hidden({name:"QRY_ID",id:"DC0075F_QRY_ID",fieldLabel: this.resourceBundle.FieldLabel.ID||"Id",allowBlank:true,width:100}));
       this.queryFields.add("NAME",new Ext.form.TextField({name:"QRY_NAME",id:"DC0075F_QRY_NAME",fieldLabel: this.resourceBundle.FieldLabel.NAME||"Name",allowBlank:true,width:100}));



       this.queryFieldsVisible = [  "NAME" ];
       N21.DataComp.DC0075.superclass.initComponent.apply(this, arguments);
     }

    ,onRender:function() {
       N21.DataComp.DC0075.superclass.onRender.apply(this, arguments);
     }
  ...
  Ext.reg("DC0075", N21.DataComp.DC0075);
