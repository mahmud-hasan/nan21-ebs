    ...
    ,initComponent:function() {
       Ext.apply(this, {
           store: new Ext.data.JsonStore({
              ...
              ,root:"records"
              ,url:CFG_BACKENDSERVER_URL+"?_p_action=fetch&_p_data_format=json&_p_form=DC0093"
              ,remoteSort :true
...
,"->","<span class='dcName'>DC0093</span>"          )
         ...
         this.columnMap.add("NAME",{ id:'NAME',header:this.resourceBundle.FieldLabel.NAME||"Name",width:200,dataIndex:'NAME',insert_allowed:true,update_allowed:true,sortable:true,editor:new Ext.form.TextField({selectOnFocus:true,allowBlank: false,caseRestriction:"Upper",style:"text-transform:uppercase;",cls:"x-form-text-in-grid"})});
    ...
    this.colModel = new Ext.grid.ColumnModel (this.columnMap.getRange());
       ...
       this.queryFields.add("NAME",new Ext.form.TextField({name:"QRY_NAME",id:"DC0093F_QRY_NAME",fieldLabel: this.resourceBundle.FieldLabel.NAME||"Name",allowBlank:true,caseRestriction:"Upper",style: "text-transform:uppercase;",width:100}));
       this.queryFields.add("IS_ACCOUNT",new Ext.form.ComboBox({name:"QRY_IS_ACCOUNT",id:"DC0093F_QRY_IS_ACCOUNT",fieldLabel: this.resourceBundle.FieldLabel.IS_ACCOUNT||"Account?",allowBlank:true,width:50,store:["%","Y","N"],value:"%"}));
