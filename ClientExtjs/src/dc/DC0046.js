 ...
 */ 
  ...
  N21.DataComp.DC0046G = Ext.extend(N21.Base.GridView, {
    ...
    ,initComponent:function() {
       ...
       this.queryFields.add("IS_CLOSED",new Ext.form.ComboBox({name:"QRY_IS_CLOSED",id:"DC0046F_QRY_IS_CLOSED",fieldLabel: this.resourceBundle.FieldLabel.IS_CLOSED||"Closed",allowBlank:true,width:100,store:["%","Y","N"],value:"%"}));
 ...
 */ 
  ...
  N21.DataComp.DC0046F = Ext.extend(N21.Base.EditForm, {
    ...
    ,initComponent:function() {
       ...
       this.fields.add("IS_CLOSED",new Ext.ux.form.XCheckbox({name:"IS_CLOSED",id:"DC0046F_IS_CLOSED",dataIndex:"IS_CLOSED",fieldLabel: this.resourceBundle.FieldLabel.IS_CLOSED||"Closed",allowBlank:true,insert_allowed:true,update_allowed:true}));
       ...
       this.layoutItems.add("Timing",
             { xtype:"fieldset", autoHeight:true,collapsible: true,title:this.resourceBundle.FieldsetTitle.Timing||"Timing",border:true,labelWidth:80,labelAlign:"left",width:"250"   ,items:[ this.fields.get("IS_CLOSED"),this.fields.get("PLAN_STARTDATE"),this.fields.get("PLAN_ENDDATE"),this.fields.get("ACT_STARTDATE"),this.fields.get("ACT_ENDDATE")] });
       ...
       this.layoutItems.add("Eval",
             { xtype:"fieldset", autoHeight:true,collapsible: true,title:this.resourceBundle.FieldsetTitle.Eval||"Eval",border:true,labelWidth:80,labelAlign:"left",width:"250"   ,items:[ this.fields.get("ISSUE_TYPE_CODE"),this.fields.get("SEVERITY_CODE"),this.fields.get("PRIORITY_CODE"),this.fields.get("STATUS_CODE"),this.fields.get("ASSIGNED_TO")] });
       ...
       this.layoutItems.add("Info",
             { xtype:"fieldset", autoHeight:true,collapsible: true,title:this.resourceBundle.FieldsetTitle.Info||"Info",border:true,labelWidth:80,labelAlign:"top",width:"500"   ,items:[ this.fields.get("ID"),this.fields.get("TITLE"),this.fields.get("DESCRIPTION")] });
       this.layoutItems.add("Effort",
             { xtype:"fieldset", autoHeight:true,collapsible: true,title:this.resourceBundle.FieldsetTitle.Effort||"Effort",border:true,labelWidth:80,labelAlign:"left",width:"220"   ,items:[ this.fields.get("EFFORT_UNIT"),this.fields.get("ESTIMATE_EFFORT"),this.fields.get("ACTUAL_EFFORT")] });
       ...
       this.layoutItems.add("Impact",
             { xtype:"fieldset", autoHeight:true,collapsible: true,title:this.resourceBundle.FieldsetTitle.Impact||"Impact",border:true,labelWidth:80,labelAlign:"left",width:"240"   ,items:[ this.fields.get("PROJECT_ID"),this.fields.get("PROJECT_NAME"),this.fields.get("AFF_PROJECT_RELEASE_CODE"),this.fields.get("AFF_CMP_TYPE_CODE"),this.fields.get("AFF_CMP")] });
