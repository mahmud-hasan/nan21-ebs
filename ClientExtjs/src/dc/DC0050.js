 ...
 * Generated content.
 * DC0050 DataControl: Project issues severities def.
 */

  Ext.ns("N21.DataComp");
  N21.DataComp.DC0050 = Ext.extend(N21.Base.GridEdit, {
    ...
    ,initComponent:function() {
       Ext.apply(this, {
           store: new Ext.data.JsonStore({
              ...
              ,root:"records"
              ,url:CFG_BACKENDSERVER_URL+"?_p_action=fetch&_p_data_format=json&_p_form=DC0050"
              ,remoteSort :true
...
,"->","<span class='dcName'>DC0050</span>"          )
    ...
    this.colModel = new Ext.grid.ColumnModel (this.columnMap.getRange());
       ...
       this.queryFields.add("ID",new Ext.form.Hidden({name:"QRY_ID",id:"DC0050F_QRY_ID",fieldLabel: this.resourceBundle.FieldLabel.ID||"Id",allowBlank:true,width:100}));
       this.queryFields.add("CODE",new Ext.form.TextField({name:"QRY_CODE",id:"DC0050F_QRY_CODE",fieldLabel: this.resourceBundle.FieldLabel.CODE||"Code",allowBlank:true,width:100}));
       this.queryFields.add("NAME",new Ext.form.TextField({name:"QRY_NAME",id:"DC0050F_QRY_NAME",fieldLabel: this.resourceBundle.FieldLabel.NAME||"Name",allowBlank:true,width:100}));
    ...
    ,onRender:function() {
       N21.DataComp.DC0050.superclass.onRender.apply(this, arguments);
     }
