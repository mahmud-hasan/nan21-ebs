...
ALTER TABLE ACCOUNTING_DOC_LINE ADD CONSTRAINT FK_ACCDOCLINM_ACCDOC FOREIGN KEY (ACCDOC_ID) REFERENCES ACCOUNTING_DOC(ID) on delete CASCADE;
...
ALTER TABLE MM_PRODUCT_ACCOUNT ADD CONSTRAINT FK_PRODACCT_ACCSCHEMA FOREIGN KEY (ACCSCHEMA_ID) REFERENCES ACC_SCHEMA(ID);

prompt Creating foreign key FK_PRODACCT_CLIENT on table MM_PRODUCT_ACCOUNT ...
ALTER TABLE MM_PRODUCT_ACCOUNT ADD CONSTRAINT FK_PRODACCT_CLIENT FOREIGN KEY (CLIENT_ID) REFERENCES CLIENT(ID);

prompt Creating foreign key FK_PRODACCT_PROD on table MM_PRODUCT_ACCOUNT ...
ALTER TABLE MM_PRODUCT_ACCOUNT ADD CONSTRAINT FK_PRODACCT_PROD FOREIGN KEY (PRODUCT_ID) REFERENCES MM_PRODUCT(ID);
