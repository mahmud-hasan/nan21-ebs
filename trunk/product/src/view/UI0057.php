 ...
 * Generated content.
 * UI0057: Reception document type
 */
  require_once(PATH_CTRL_FRMWK."/gui_lib.php");
  print print_page_header();
?>
  <script type="text/javascript" src="_static/js/dc/DC0079.js"></script>
  <script type="text/javascript" src="_static/locale/DC0079_<?php print $_SESSION["user"]["language"];?>.js"></script>
