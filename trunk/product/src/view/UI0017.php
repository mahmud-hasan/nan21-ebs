 ...
 * Generated content.
 * UI0017: UI Lists of values (LOV)
 */
  require_once(PATH_CTRL_FRMWK."/gui_lib.php");
  print print_page_header();
?>
  <script type="text/javascript" src="_static/js/dc/DC0025.js"></script>
  <script type="text/javascript" src="_static/locale/DC0025_<?php print $_SESSION["user"]["language"];?>.js"></script>
...
<script><!--
  ...
  DC0025 = new N21.DataComp.DC0025({id:"DC0025", autoScroll:true });
