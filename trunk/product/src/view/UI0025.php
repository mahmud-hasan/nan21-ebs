 ...
 * Generated content.
 * UI0025: DC role permission
 */
  require_once(PATH_CTRL_FRMWK."/gui_lib.php");
  print print_page_header();
?>
  <script type="text/javascript" src="_static/js/dc/DC0071.js"></script>
  <script type="text/javascript" src="_static/locale/DC0071_<?php print $_SESSION["user"]["language"];?>.js"></script>
...
<script><!--
  ...
  DC0071 = new N21.DataComp.DC0071({id:"DC0071", autoScroll:true });
  var gui = new Ext.Viewport({
    ...
    ,{ region: "north",border: false, html:"<div class='gui_title'>"+(N21.DataComp.DC0071.prototype.resourceBundle.DcProperty.Title||"DC role permission")+" &nbsp;&nbsp;&nbsp;<font size=-2>&lt;UI0025&gt;</div>"}
   ]
});
gui.findById("DC0071").executeQuery();
  });
--></script>
  <div id="north"></div>
</body>
