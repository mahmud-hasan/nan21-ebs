...
?>
  <script type="text/javascript" src="_static/js/dc/DC0062.js"></script>
  <script type="text/javascript" src="_static/locale/DC0062_<?php print $_SESSION["user"]["language"];?>.js"></script>
