...
?>
  <script type="text/javascript" src="_static/js/dc/DC0075.js"></script>
  <script type="text/javascript" src="_static/locale/DC0075_<?php print $_SESSION["user"]["language"];?>.js"></script>
