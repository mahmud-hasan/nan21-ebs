 ...
 */ 
  ...
  N21.DataComp.DC0078G = Ext.extend(N21.Base.GridView, {
    ...
    ,initComponent:function() {
       ...
       this.queryFields.add("QTY_CHECK",new Ext.form.ComboBox({name:"QRY_QTY_CHECK",id:"DC0078F_QRY_QTY_CHECK",fieldLabel: this.resourceBundle.FieldLabel.QTY_CHECK||"Qty check",allowBlank:true,width:40,store:["Y","N"]}));
       this.queryFields.add("QUALITY_CHECK",new Ext.form.ComboBox({name:"QRY_QUALITY_CHECK",id:"DC0078F_QRY_QUALITY_CHECK",fieldLabel: this.resourceBundle.FieldLabel.QUALITY_CHECK||"Quality check",allowBlank:true,width:40,store:["Y","N"]}));
       this.queryFields.add("VALUE_CHECK",new Ext.form.ComboBox({name:"QRY_VALUE_CHECK",id:"DC0078F_QRY_VALUE_CHECK",fieldLabel: this.resourceBundle.FieldLabel.VALUE_CHECK||"Value check",allowBlank:true,width:40,store:["Y","N"]}));
 ...
 */ 
  ...
  N21.DataComp.DC0078F = Ext.extend(N21.Base.EditForm, {
    ...
    ,initComponent:function() {
       ...
       this.fields.add("QTY_CHECK",new Ext.ux.form.XCheckbox({name:"QTY_CHECK",id:"DC0078F_QTY_CHECK",dataIndex:"QTY_CHECK",fieldLabel: this.resourceBundle.FieldLabel.QTY_CHECK||"Qty check",allowBlank:true,width:50,insert_allowed:false,update_allowed:true}));
       ...
       this.fields.add("QUALITY_CHECK",new Ext.ux.form.XCheckbox({name:"QUALITY_CHECK",id:"DC0078F_QUALITY_CHECK",dataIndex:"QUALITY_CHECK",fieldLabel: this.resourceBundle.FieldLabel.QUALITY_CHECK||"Quality check",allowBlank:true,width:50,insert_allowed:true,update_allowed:true}));
       ...
       this.fields.add("VALUE_CHECK",new Ext.ux.form.XCheckbox({name:"VALUE_CHECK",id:"DC0078F_VALUE_CHECK",dataIndex:"VALUE_CHECK",fieldLabel: this.resourceBundle.FieldLabel.VALUE_CHECK||"Value check",allowBlank:true,width:50,insert_allowed:false,update_allowed:true}));
