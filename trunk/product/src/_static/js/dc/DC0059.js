 ...
 */ 
  ...
  N21.DataComp.DC0059F = Ext.extend(N21.Base.EditForm, {
    ...
    ,initComponent:function() {
       ...
       this.fields.add("CREATEDON",new Ext.form.DateField({name:"CREATEDON",id:"DC0059F_CREATEDON",dataIndex:"CREATEDON",fieldLabel: this.resourceBundle.FieldLabel.CREATEDON||"Created on",allowBlank:false,labelSeparator:":*",width:80,disabled:true,format:Ext.DATE_FORMAT}));
       ...
       this.fields.add("MODIFIEDON",new Ext.form.DateField({name:"MODIFIEDON",id:"DC0059F_MODIFIEDON",dataIndex:"MODIFIEDON",fieldLabel: this.resourceBundle.FieldLabel.MODIFIEDON||"Modifiedon",allowBlank:false,labelSeparator:":*",width:80,disabled:true,format:Ext.DATE_FORMAT}));
