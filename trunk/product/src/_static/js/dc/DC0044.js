 ...
 */ 
  ...
  N21.DataComp.DC0044G = Ext.extend(N21.Base.GridView, {
    ...
    ,initComponent:function() {
       ...
       this.queryFields.add("IS_PAYABLE",new Ext.form.Hidden({name:"QRY_IS_PAYABLE",id:"DC0044F_QRY_IS_PAYABLE",fieldLabel: this.resourceBundle.FieldLabel.IS_PAYABLE||"Is_payable",allowBlank:true,width:100,store:["Y","N"]}));
       this.queryFields.add("IS_RECEIVABLE",new Ext.form.Hidden({name:"QRY_IS_RECEIVABLE",id:"DC0044F_QRY_IS_RECEIVABLE",fieldLabel: this.resourceBundle.FieldLabel.IS_RECEIVABLE||"Is_receivable",allowBlank:true,width:100,store:["Y","N"]}));
       ...
       this.queryFields.add("IS_INSERTED",new Ext.form.ComboBox({name:"QRY_IS_INSERTED",id:"DC0044F_QRY_IS_INSERTED",fieldLabel: this.resourceBundle.FieldLabel.IS_INSERTED||"Is_inserted",allowBlank:true,width:100,store:["Y","N"]}));
       this.queryFields.add("IS_GENERATED",new Ext.form.ComboBox({name:"QRY_IS_GENERATED",id:"DC0044F_QRY_IS_GENERATED",fieldLabel: this.resourceBundle.FieldLabel.IS_GENERATED||"Is_generated",allowBlank:true,width:100,store:["Y","N"]}));
       this.queryFields.add("IS_APPROVED",new Ext.form.ComboBox({name:"QRY_IS_APPROVED",id:"DC0044F_QRY_IS_APPROVED",fieldLabel: this.resourceBundle.FieldLabel.IS_APPROVED||"Is_approved",allowBlank:true,width:100,store:["Y","N"]}));
       this.queryFields.add("IS_POSTED",new Ext.form.ComboBox({name:"QRY_IS_POSTED",id:"DC0044F_QRY_IS_POSTED",fieldLabel: this.resourceBundle.FieldLabel.IS_POSTED||"Is_posted",allowBlank:true,width:100,store:["Y","N"]}));
       ...
       this.queryFields.add("IS_PREPAYMENT",new Ext.form.ComboBox({name:"QRY_IS_PREPAYMENT",id:"DC0044F_QRY_IS_PREPAYMENT",fieldLabel: this.resourceBundle.FieldLabel.IS_PREPAYMENT||"Is_prepayment",allowBlank:true,width:100,store:["Y","N"]}));
       ...
       this.queryFields.add("IS_MULTI_PAYMENT",new Ext.form.Hidden({name:"QRY_IS_MULTI_PAYMENT",id:"DC0044F_QRY_IS_MULTI_PAYMENT",fieldLabel: this.resourceBundle.FieldLabel.IS_MULTI_PAYMENT||"Is_multi_payment",allowBlank:true,width:100,store:["Y","N"]}));
