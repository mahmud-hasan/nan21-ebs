    ...
    ,initComponent:function() {
       ...
       Ext.apply(this, {
           store: new Ext.data.JsonStore({
              ...
              ,root:"records"
              ,url:"frmMain.php?_p_action=fetch&_p_data_format=json&_p_form=DC0064"
              ,remoteSort :true
 ...
 */ 
  ...
  N21.DataComp.DC0064F = Ext.extend(N21.Base.EditForm, {
    ...
    ,initComponent:function() {
       ...
       this.fields.add("ID", new Ext.form.Hidden ({xtype: "hidden",name:"ID",id:"DC0064F_ID",dataIndex:"ID",width:100,allowBlank:false,labelSeparator:":*" ,fieldLabel: this.resourceBundle.FieldLabel.ID||"Id",insert_allowed:true,update_allowed:true})   );
       this.fields.add("PORDER_ID", new Ext.form.Hidden ({xtype: "hidden",name:"PORDER_ID",id:"DC0064F_PORDER_ID",dataIndex:"PORDER_ID",width:100,allowBlank:false,labelSeparator:":*" ,fieldLabel: this.resourceBundle.FieldLabel.PORDER_ID||"Porder_id",insert_allowed:true,update_allowed:true})   );
       this.fields.add("LINE_NR", new Ext.form.NumberField ({xtype: "numberfield",name:"LINE_NR",id:"DC0064F_LINE_NR",dataIndex:"LINE_NR",width:50,allowBlank:false,labelSeparator:":*" ,fieldLabel: this.resourceBundle.FieldLabel.LINE_NR||"No",insert_allowed:true,update_allowed:true,decimalPrecision:2,style: "text-align:right;"})   );
       this.fields.add("PRODUCT_NAME", new N21.DataComp.LOV0017({xtype: "LOV0017",fieldMapping: [{column:"ID",field:"DC0064F_PRODUCT_ID"},{column:"NAME",field:"DC0064F_PRODUCT_NAME"}],selectOnFocus:true,name:"PRODUCT_NAME",id:"DC0064F_PRODUCT_NAME",dataIndex:"PRODUCT_NAME",width:250,allowBlank:false,labelSeparator:":*" ,fieldLabel: this.resourceBundle.FieldLabel.PRODUCT_NAME||"Product",insert_allowed:true,update_allowed:true})   );
       this.fields.add("PRODUCT_ID", new Ext.form.Hidden ({xtype: "hidden",name:"PRODUCT_ID",id:"DC0064F_PRODUCT_ID",dataIndex:"PRODUCT_ID",width:100,allowBlank:true,fieldLabel: this.resourceBundle.FieldLabel.PRODUCT_ID||"Product_id",insert_allowed:true,update_allowed:true})   );
       this.fields.add("QTY", new Ext.form.NumberField ({xtype: "numberfield",name:"QTY",id:"DC0064F_QTY",dataIndex:"QTY",width:80,allowBlank:false,labelSeparator:":*" ,fieldLabel: this.resourceBundle.FieldLabel.QTY||"Qty",insert_allowed:true,update_allowed:true,decimalPrecision:2,style: "text-align:right;"})   );
       this.fields.add("UOM_CODE", new N21.DataComp.LOV0002({xtype: "LOV0002",selectOnFocus:true,name:"UOM_CODE",id:"DC0064F_UOM_CODE",dataIndex:"UOM_CODE",width:80,listWidth:98,allowBlank:false,labelSeparator:":*" ,fieldLabel: this.resourceBundle.FieldLabel.UOM_CODE||"UoM",insert_allowed:true,update_allowed:true,style: "text-transform:uppercase;"})   );
       this.fields.add("PRICE", new Ext.form.NumberField ({xtype: "numberfield",name:"PRICE",id:"DC0064F_PRICE",dataIndex:"PRICE",width:80,allowBlank:true,fieldLabel: this.resourceBundle.FieldLabel.PRICE||"Price",insert_allowed:true,update_allowed:true,decimalPrecision:2,style: "text-align:right;"})   );
       this.fields.add("CURRENCY_CODE", new N21.DataComp.LOV0001({xtype: "LOV0001",selectOnFocus:true,name:"CURRENCY_CODE",id:"DC0064F_CURRENCY_CODE",dataIndex:"CURRENCY_CODE",width:80,listWidth:98,allowBlank:true,fieldLabel: this.resourceBundle.FieldLabel.CURRENCY_CODE||"Currency",insert_allowed:true,update_allowed:true,style: "text-transform:uppercase;"})   );
       this.fields.add("NET_AMOUNT", new Ext.form.NumberField ({xtype: "numberfield",name:"NET_AMOUNT",id:"DC0064F_NET_AMOUNT",dataIndex:"NET_AMOUNT",width:100,allowBlank:false,labelSeparator:":*" ,fieldLabel: this.resourceBundle.FieldLabel.NET_AMOUNT||"Net amount",insert_allowed:true,update_allowed:true,decimalPrecision:2,style: "text-align:right;"})   );
       this.fields.add("NOTES", new Ext.form.TextField ({xtype: "textfield",name:"NOTES",id:"DC0064F_NOTES",dataIndex:"NOTES",width:200,allowBlank:true,fieldLabel: this.resourceBundle.FieldLabel.NOTES||"Notes",insert_allowed:true,update_allowed:true})   );
       this.fields.add("DATE_REQUESTED", new Ext.form.DateField ({xtype: "datefield",name:"DATE_REQUESTED",id:"DC0064F_DATE_REQUESTED",dataIndex:"DATE_REQUESTED",width:100,allowBlank:true,fieldLabel: this.resourceBundle.FieldLabel.DATE_REQUESTED||"Requested for",insert_allowed:true,update_allowed:true,format:Ext.DATE_FORMAT})   );
       this.fields.add("DATE_PROMISED", new Ext.form.DateField ({xtype: "datefield",name:"DATE_PROMISED",id:"DC0064F_DATE_PROMISED",dataIndex:"DATE_PROMISED",width:100,allowBlank:true,fieldLabel: this.resourceBundle.FieldLabel.DATE_PROMISED||"Promised for",insert_allowed:true,update_allowed:true,format:Ext.DATE_FORMAT})   );
       this.fields.add("DATE_DELIVERED", new Ext.form.DateField ({xtype: "datefield",name:"DATE_DELIVERED",id:"DC0064F_DATE_DELIVERED",dataIndex:"DATE_DELIVERED",width:100,allowBlank:true,fieldLabel: this.resourceBundle.FieldLabel.DATE_DELIVERED||"Delivered on",insert_allowed:true,update_allowed:true,format:Ext.DATE_FORMAT})   );
