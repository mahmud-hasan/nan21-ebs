 ...
 */ 
  ...
  N21.DataComp.DC0064G = Ext.extend(N21.Base.GridView, {
    ...
    ,initComponent:function() {
       ...
       this.queryFields.add("UOM_CODE",new  N21.DataComp.LOV0002({name:"QRY_UOM_CODE",id:"DC0064F_QRY_UOM_CODE",fieldLabel: this.resourceBundle.FieldLabel.UOM_CODE||"UoM",allowBlank:true,style: "text-transform:uppercase;",width:100,listWidth:118,selectOnFocus:true}));
       ...
       this.queryFields.add("CURRENCY_CODE",new  N21.DataComp.LOV0001({name:"QRY_CURRENCY_CODE",id:"DC0064F_QRY_CURRENCY_CODE",fieldLabel: this.resourceBundle.FieldLabel.CURRENCY_CODE||"Currency",allowBlank:true,style: "text-transform:uppercase;",width:100,listWidth:118,selectOnFocus:true}));
 ...
 */ 
  ...
  N21.DataComp.DC0064F = Ext.extend(N21.Base.EditForm, {
    ...
    ,initComponent:function() {
       ...
       this.fields.add("CURRENCY_CODE",new  N21.DataComp.LOV0001({name:"CURRENCY_CODE",id:"DC0064F_CURRENCY_CODE",dataIndex:"CURRENCY_CODE",fieldLabel: this.resourceBundle.FieldLabel.CURRENCY_CODE||"Currency",allowBlank:true,width:80,listWidth:98,insert_allowed:true,update_allowed:true,style: "text-transform:uppercase;",selectOnFocus:true}));
