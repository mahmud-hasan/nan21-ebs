  ...
  N21.DataComp.DC0058 = Ext.extend(N21.Base.GridEdit, {
    ...
    ,initComponent:function() {
       ...
       Ext.apply(this, {
          ...
          ,queryFields: [
                {xtype: "numberfield",name:"QRY_ID",id:"DC0058_QRY_ID",width:120,fieldLabel: this.resourceBundle.FieldLabel.ID||"Id",style: "text-align:right;"}
               ,{xtype: "numberfield",name:"QRY_BPARTNER_ID",id:"DC0058_QRY_BPARTNER_ID",width:120,fieldLabel: this.resourceBundle.FieldLabel.BPARTNER_ID||"Bpartner_id",style: "text-align:right;"}
               ,{xtype: "LOV0038",name:"QRY_CMNCT_TYPE",id:"DC0058_QRY_CMNCT_TYPE",width:120,fieldLabel: this.resourceBundle.FieldLabel.CMNCT_TYPE||"Type"}
               ,{xtype: "textfield",name:"QRY_CMNCT_VALUE",id:"DC0058_QRY_CMNCT_VALUE",width:120,fieldLabel: this.resourceBundle.FieldLabel.CMNCT_VALUE||"Value"}
          ]
