 ...
 */ 
  ...
  N21.DataComp.DC0016G = Ext.extend(N21.Base.GridView, {
    ...
    ,initComponent:function() {
       ...
       this.queryFields.add("CLIENT_ID",new Ext.form.Hidden({name:"QRY_CLIENT_ID",id:"DC0016F_QRY_CLIENT_ID",fieldLabel: this.resourceBundle.FieldLabel.CLIENT_ID||"Client_id",allowBlank:true,width:100}));
       ...
       this.queryFields.add("EXP_BPADRESS_ID",new Ext.form.Hidden({name:"QRY_EXP_BPADRESS_ID",id:"DC0016F_QRY_EXP_BPADRESS_ID",fieldLabel: this.resourceBundle.FieldLabel.EXP_BPADRESS_ID||"Exp adress id",allowBlank:true,width:100}));
       this.queryFields.add("EXP_BPARTNER_ID",new Ext.form.Hidden({name:"QRY_EXP_BPARTNER_ID",id:"DC0016F_QRY_EXP_BPARTNER_ID",fieldLabel: this.resourceBundle.FieldLabel.EXP_BPARTNER_ID||"Exp_bpartner_id",allowBlank:true,width:100}));
       this.queryFields.add("EXP_CITY_ID",new Ext.form.Hidden({name:"QRY_EXP_CITY_ID",id:"DC0016F_QRY_EXP_CITY_ID",fieldLabel: this.resourceBundle.FieldLabel.EXP_CITY_ID||"Exp_city_id",allowBlank:true,width:100}));
       this.queryFields.add("EXP_NAME",new  N21.DataComp.LOV0039({name:"QRY_EXP_NAME",id:"DC0016F_QRY_EXP_NAME",fieldLabel: this.resourceBundle.FieldLabel.EXP_NAME||"Exp_name",allowBlank:true,width:100,selectOnFocus:true,fieldMapping: [{column:"ID",field:"DC0016F_QRY_EXP_BPARTNER_ID"},{column:"COUNTRY_CODE",field:"DC0016F_QRY_EXP_COUNTRY"},{column:"REGION_CODE",field:"DC0016F_QRY_EXP_REGION"},{column:"CITY",field:"DC0016F_QRY_EXP_CITY"},{column:"ADRESS",field:"DC0016F_QRY_EXP_BPADRESS"}]}));
       this.queryFields.add("DEST_BPARTNER_ID",new Ext.form.Hidden({name:"QRY_DEST_BPARTNER_ID",id:"DC0016F_QRY_DEST_BPARTNER_ID",fieldLabel: this.resourceBundle.FieldLabel.DEST_BPARTNER_ID||"Dest_bpartner_id",allowBlank:true,width:100}));
       this.queryFields.add("DEST_BPADRESS_ID",new Ext.form.Hidden({name:"QRY_DEST_BPADRESS_ID",id:"DC0016F_QRY_DEST_BPADRESS_ID",fieldLabel: this.resourceBundle.FieldLabel.DEST_BPADRESS_ID||"Dest adress id",allowBlank:true,width:100}));
       this.queryFields.add("DEST_CITY_ID",new Ext.form.Hidden({name:"QRY_DEST_CITY_ID",id:"DC0016F_QRY_DEST_CITY_ID",fieldLabel: this.resourceBundle.FieldLabel.DEST_CITY_ID||"Dest_city_id",allowBlank:true,width:100}));
       this.queryFields.add("DEST_NAME",new  N21.DataComp.LOV0039({name:"QRY_DEST_NAME",id:"DC0016F_QRY_DEST_NAME",fieldLabel: this.resourceBundle.FieldLabel.DEST_NAME||"Dest_name",allowBlank:true,width:100,selectOnFocus:true,fieldMapping: [{column:"ID",field:"DC0016F_QRY_DEST_BPARTNER_ID"},{column:"COUNTRY_CODE",field:"DC0016F_QRY_DEST_COUNTRY"},{column:"REGION_CODE",field:"DC0016F_QRY_DEST_REGION"},{column:"CITY",field:"DC0016F_QRY_DEST_CITY"},{column:"ADRESS",field:"DC0016F_QRY_DEST_BPADRESS"}]}));
       this.queryFields.add("PICKUP_AGENT_CODE",new  N21.DataComp.LOV0016({name:"QRY_PICKUP_AGENT_CODE",id:"DC0016F_QRY_PICKUP_AGENT_CODE",fieldLabel: this.resourceBundle.FieldLabel.PICKUP_AGENT_CODE||"Pickup agent",allowBlank:true,width:100,listWidth:118,selectOnFocus:true}));
       this.queryFields.add("DELIVERED",new Ext.form.ComboBox({name:"QRY_DELIVERED",id:"DC0016F_QRY_DELIVERED",fieldLabel: this.resourceBundle.FieldLabel.DELIVERED||"Delivered",allowBlank:true,width:50,store:["Y","N"]}));
       this.queryFields.add("DELIVERY_AGENT_CODE",new  N21.DataComp.LOV0016({name:"QRY_DELIVERY_AGENT_CODE",id:"DC0016F_QRY_DELIVERY_AGENT_CODE",fieldLabel: this.resourceBundle.FieldLabel.DELIVERY_AGENT_CODE||"Delivery agent",allowBlank:true,width:100,listWidth:118,selectOnFocus:true}));
       this.queryFields.add("REJECTED",new Ext.form.ComboBox({name:"QRY_REJECTED",id:"DC0016F_QRY_REJECTED",fieldLabel: this.resourceBundle.FieldLabel.REJECTED||"Rejected",allowBlank:true,width:50,store:["Y","N"]}));
  
       this.queryFieldsVisible = [  "CLIENT_CODE","CODE","EXP_NAME","DEST_NAME","PICKUP_AGENT_CODE","DELIVERED","DELIVERY_AGENT_CODE","REJECTED" ];
       Ext.apply(this, {
 ...
 */ 
  ...
  N21.DataComp.DC0016F = Ext.extend(N21.Base.EditForm, {
    ...
    ,initComponent:function() {
       ...
       this.fields.add("CLIENT_ID",new Ext.form.Hidden({name:"CLIENT_ID",id:"DC0016F_CLIENT_ID",dataIndex:"CLIENT_ID",fieldLabel: this.resourceBundle.FieldLabel.CLIENT_ID||"Client_id",allowBlank:false,labelSeparator:":*",width:100,insert_allowed:true,update_allowed:true}));
       ...
       this.fields.add("EXP_BPARTNER_ID",new Ext.form.Hidden({name:"EXP_BPARTNER_ID",id:"DC0016F_EXP_BPARTNER_ID",dataIndex:"EXP_BPARTNER_ID",fieldLabel: this.resourceBundle.FieldLabel.EXP_BPARTNER_ID||"Exp_bpartner_id",allowBlank:true,width:100,insert_allowed:true,update_allowed:true}));
       this.fields.add("EXP_BPADRESS_ID",new Ext.form.Hidden({name:"EXP_BPADRESS_ID",id:"DC0016F_EXP_BPADRESS_ID",dataIndex:"EXP_BPADRESS_ID",fieldLabel: this.resourceBundle.FieldLabel.EXP_BPADRESS_ID||"Exp adress id",allowBlank:true,width:100,insert_allowed:true,update_allowed:true}));
       this.fields.add("EXP_CITY_ID",new Ext.form.Hidden({name:"EXP_CITY_ID",id:"DC0016F_EXP_CITY_ID",dataIndex:"EXP_CITY_ID",fieldLabel: this.resourceBundle.FieldLabel.EXP_CITY_ID||"Exp_city_id",allowBlank:true,width:100,insert_allowed:true,update_allowed:true}));
       this.fields.add("EXP_NAME",new  N21.DataComp.LOV0039({name:"EXP_NAME",id:"DC0016F_EXP_NAME",dataIndex:"EXP_NAME",fieldLabel: this.resourceBundle.FieldLabel.EXP_NAME||"Exp_name",allowBlank:true,width:200,insert_allowed:true,update_allowed:true,selectOnFocus:true,fieldMapping: [{column:"ID",field:"DC0016F_EXP_BPARTNER_ID"},{column:"COUNTRY_CODE",field:"DC0016F_EXP_COUNTRY"},{column:"REGION_CODE",field:"DC0016F_EXP_REGION"},{column:"CITY",field:"DC0016F_EXP_CITY"},{column:"ADRESS",field:"DC0016F_EXP_BPADRESS"}]}));
       ...
       this.fields.add("EXP_CITY",new  N21.DataComp.LOV0010({name:"EXP_CITY",id:"DC0016F_EXP_CITY",dataIndex:"EXP_CITY",fieldLabel: this.resourceBundle.FieldLabel.EXP_CITY||"Exp_city",allowBlank:true,width:150,listWidth:168,insert_allowed:true,update_allowed:true,selectOnFocus:true,fieldMapping: [{column:"ID",field:"DC0016F_EXP_CITY_ID"}],paramMapping: [{param:"p_country_code",field:"DC0016F.EXP_COUNTRY"},{param:"p_region_code",field:"DC0016F.EXP_REGION"}]}));
       ...
       this.fields.add("EXP_ZIP",new Ext.form.TextField({name:"EXP_ZIP",id:"DC0016F_EXP_ZIP",dataIndex:"EXP_ZIP",fieldLabel: this.resourceBundle.FieldLabel.EXP_ZIP||"Exp_zip",allowBlank:true,width:80,insert_allowed:true,update_allowed:true}));
       this.fields.add("EXP_ADRESS_NOTE",new Ext.form.TextField({name:"EXP_ADRESS_NOTE",id:"DC0016F_EXP_ADRESS_NOTE",dataIndex:"EXP_ADRESS_NOTE",fieldLabel: this.resourceBundle.FieldLabel.EXP_ADRESS_NOTE||"Exp_adress_note",allowBlank:true,width:200,insert_allowed:true,update_allowed:true}));
       this.fields.add("DEST_BPARTNER_ID",new Ext.form.Hidden({name:"DEST_BPARTNER_ID",id:"DC0016F_DEST_BPARTNER_ID",dataIndex:"DEST_BPARTNER_ID",fieldLabel: this.resourceBundle.FieldLabel.DEST_BPARTNER_ID||"Dest_bpartner_id",allowBlank:true,width:100,insert_allowed:true,update_allowed:true}));
       this.fields.add("DEST_BPADRESS_ID",new Ext.form.Hidden({name:"DEST_BPADRESS_ID",id:"DC0016F_DEST_BPADRESS_ID",dataIndex:"DEST_BPADRESS_ID",fieldLabel: this.resourceBundle.FieldLabel.DEST_BPADRESS_ID||"Dest adress id",allowBlank:true,width:100,insert_allowed:true,update_allowed:true}));
       this.fields.add("DEST_CITY_ID",new Ext.form.Hidden({name:"DEST_CITY_ID",id:"DC0016F_DEST_CITY_ID",dataIndex:"DEST_CITY_ID",fieldLabel: this.resourceBundle.FieldLabel.DEST_CITY_ID||"Dest_city_id",allowBlank:true,width:100,insert_allowed:true,update_allowed:true}));
       this.fields.add("DEST_NAME",new  N21.DataComp.LOV0039({name:"DEST_NAME",id:"DC0016F_DEST_NAME",dataIndex:"DEST_NAME",fieldLabel: this.resourceBundle.FieldLabel.DEST_NAME||"Dest_name",allowBlank:true,width:200,insert_allowed:true,update_allowed:true,selectOnFocus:true,fieldMapping: [{column:"ID",field:"DC0016F_DEST_BPARTNER_ID"},{column:"COUNTRY_CODE",field:"DC0016F_DEST_COUNTRY"},{column:"REGION_CODE",field:"DC0016F_DEST_REGION"},{column:"CITY",field:"DC0016F_DEST_CITY"},{column:"ADRESS",field:"DC0016F_DEST_BPADRESS"}]}));
       this.fields.add("DEST_COUNTRY",new  N21.DataComp.LOV0006({name:"DEST_COUNTRY",id:"DC0016F_DEST_COUNTRY",dataIndex:"DEST_COUNTRY",fieldLabel: this.resourceBundle.FieldLabel.DEST_COUNTRY||"Dest_country",allowBlank:true,width:120,listWidth:138,insert_allowed:true,update_allowed:true,selectOnFocus:true}));
       ...
       this.fields.add("DEST_BPADRESS",new Ext.form.TextField({name:"DEST_BPADRESS",id:"DC0016F_DEST_BPADRESS",dataIndex:"DEST_BPADRESS",fieldLabel: this.resourceBundle.FieldLabel.DEST_BPADRESS||"Dest_bpadress",allowBlank:true,width:200,insert_allowed:true,update_allowed:true}));
       this.fields.add("DEST_ZIP",new Ext.form.TextField({name:"DEST_ZIP",id:"DC0016F_DEST_ZIP",dataIndex:"DEST_ZIP",fieldLabel: this.resourceBundle.FieldLabel.DEST_ZIP||"Dest_zip",allowBlank:true,width:80,insert_allowed:true,update_allowed:true}));
       this.fields.add("DEST_ADRESS_NOTE",new Ext.form.TextField({name:"DEST_ADRESS_NOTE",id:"DC0016F_DEST_ADRESS_NOTE",dataIndex:"DEST_ADRESS_NOTE",fieldLabel: this.resourceBundle.FieldLabel.DEST_ADRESS_NOTE||"Dest_adress_note",allowBlank:true,width:200,insert_allowed:true,update_allowed:true}));
       this.fields.add("PICKEDUP",new Ext.ux.form.XCheckbox({name:"PICKEDUP",id:"DC0016F_PICKEDUP",dataIndex:"PICKEDUP",fieldLabel: this.resourceBundle.FieldLabel.PICKEDUP||"Pickedup",allowBlank:true,width:50,insert_allowed:true,update_allowed:true}));
       this.fields.add("PICKUP_MODE",new Ext.form.TextField({name:"PICKUP_MODE",id:"DC0016F_PICKUP_MODE",dataIndex:"PICKUP_MODE",fieldLabel: this.resourceBundle.FieldLabel.PICKUP_MODE||"Pickup_mode",allowBlank:true,width:80,insert_allowed:true,update_allowed:true}));
       this.fields.add("PICKUP_DATE",new Ext.form.DateField({name:"PICKUP_DATE",id:"DC0016F_PICKUP_DATE",dataIndex:"PICKUP_DATE",fieldLabel: this.resourceBundle.FieldLabel.PICKUP_DATE||"Pickup_date",allowBlank:true,width:100,insert_allowed:true,update_allowed:true,format:Ext.DATE_FORMAT}));
       this.fields.add("PICKUP_AGENT_CODE",new  N21.DataComp.LOV0016({name:"PICKUP_AGENT_CODE",id:"DC0016F_PICKUP_AGENT_CODE",dataIndex:"PICKUP_AGENT_CODE",fieldLabel: this.resourceBundle.FieldLabel.PICKUP_AGENT_CODE||"Pickup agent",allowBlank:true,width:100,listWidth:118,insert_allowed:true,update_allowed:true,selectOnFocus:true}));
       this.fields.add("DELIVERED",new Ext.ux.form.XCheckbox({name:"DELIVERED",id:"DC0016F_DELIVERED",dataIndex:"DELIVERED",fieldLabel: this.resourceBundle.FieldLabel.DELIVERED||"Delivered",allowBlank:true,width:50,insert_allowed:true,update_allowed:true}));
       this.fields.add("DELIVERY_MODE",new Ext.form.TextField({name:"DELIVERY_MODE",id:"DC0016F_DELIVERY_MODE",dataIndex:"DELIVERY_MODE",fieldLabel: this.resourceBundle.FieldLabel.DELIVERY_MODE||"Delivery_mode",allowBlank:true,width:80,insert_allowed:true,update_allowed:true}));
       this.fields.add("DELIVERY_DATE",new Ext.form.DateField({name:"DELIVERY_DATE",id:"DC0016F_DELIVERY_DATE",dataIndex:"DELIVERY_DATE",fieldLabel: this.resourceBundle.FieldLabel.DELIVERY_DATE||"Delivery_date",allowBlank:true,width:100,insert_allowed:true,update_allowed:true,format:Ext.DATE_FORMAT}));
       this.fields.add("DELIVERY_AGENT_CODE",new  N21.DataComp.LOV0016({name:"DELIVERY_AGENT_CODE",id:"DC0016F_DELIVERY_AGENT_CODE",dataIndex:"DELIVERY_AGENT_CODE",fieldLabel: this.resourceBundle.FieldLabel.DELIVERY_AGENT_CODE||"Delivery agent",allowBlank:true,width:100,listWidth:118,insert_allowed:true,update_allowed:true,selectOnFocus:true}));
       ...
       this.fields.add("REJECTED",new Ext.ux.form.XCheckbox({name:"REJECTED",id:"DC0016F_REJECTED",dataIndex:"REJECTED",fieldLabel: this.resourceBundle.FieldLabel.REJECTED||"Rejected",allowBlank:true,width:50,insert_allowed:true,update_allowed:true}));
       ...
       this.fields.add("REJECT_REASON",new Ext.form.TextField({name:"REJECT_REASON",id:"DC0016F_REJECT_REASON",dataIndex:"REJECT_REASON",fieldLabel: this.resourceBundle.FieldLabel.REJECT_REASON||"Reject_reason",allowBlank:true,width:200,insert_allowed:true,update_allowed:true}));
       this.fields.add("REJECTED_BY_NAME",new Ext.form.TextField({name:"REJECTED_BY_NAME",id:"DC0016F_REJECTED_BY_NAME",dataIndex:"REJECTED_BY_NAME",fieldLabel: this.resourceBundle.FieldLabel.REJECTED_BY_NAME||"Rejected_by_name",allowBlank:true,width:100,insert_allowed:true,update_allowed:true}));
       this.fields.add("REJECTED_BY_IDENT",new Ext.form.TextField({name:"REJECTED_BY_IDENT",id:"DC0016F_REJECTED_BY_IDENT",dataIndex:"REJECTED_BY_IDENT",fieldLabel: this.resourceBundle.FieldLabel.REJECTED_BY_IDENT||"Rejected_by_ident",allowBlank:true,width:80,insert_allowed:true,update_allowed:true}));
       ...
       this.fields.add("DECLARED_VALUE",new Ext.form.NumberField({name:"DECLARED_VALUE",id:"DC0016F_DECLARED_VALUE",dataIndex:"DECLARED_VALUE",fieldLabel: this.resourceBundle.FieldLabel.DECLARED_VALUE||"Declared_value",allowBlank:true,width:100,insert_allowed:true,update_allowed:true,style: "text-align:right;",decimalPrecision:2}));
       this.fields.add("INSURED_VALUE",new Ext.form.NumberField({name:"INSURED_VALUE",id:"DC0016F_INSURED_VALUE",dataIndex:"INSURED_VALUE",fieldLabel: this.resourceBundle.FieldLabel.INSURED_VALUE||"Insured_value",allowBlank:true,width:100,insert_allowed:true,update_allowed:true,style: "text-align:right;",decimalPrecision:2}));
       ...
       this.layoutItems.add("Pickup",
             { xtype:"fieldset", autoHeight:true,collapsible: true,title:this.resourceBundle.FieldsetTitle.Pickup||"Pickup",border:true,labelAlign:"left",width:"230"   ,items:[ this.fields.get("PICKEDUP"),this.fields.get("PICKUP_MODE"),this.fields.get("PICKUP_DATE"),this.fields.get("PICKUP_AGENT_CODE")] });
       this.layoutItems.add("Delivery",
             { xtype:"fieldset", autoHeight:true,collapsible: true,title:this.resourceBundle.FieldsetTitle.Delivery||"Delivery",border:true,labelAlign:"left",width:"230"   ,items:[ this.fields.get("DELIVERED"),this.fields.get("DELIVERY_MODE"),this.fields.get("DELIVERY_DATE"),this.fields.get("DELIVERY_AGENT_CODE"),this.fields.get("DELIVERED_TO_NAME"),this.fields.get("DELIVERED_TO_IDENT")] });
       this.layoutItems.add("C3",
             { layout:"form",width:260,labelAlign:"left",labelWidth:100, items:[ this.layoutItems.get("Pickup"),this.layoutItems.get("Delivery")]
 }); 
       this.layoutItems.add("Receiver",
             { xtype:"fieldset", autoHeight:true,collapsible: true,title:this.resourceBundle.FieldsetTitle.Receiver||"Receiver",border:true,labelAlign:"left",width:"330"   ,items:[ this.fields.get("DEST_BPARTNER_ID"),this.fields.get("DEST_BPADRESS_ID"),this.fields.get("DEST_CITY_ID"),this.fields.get("DEST_NAME"),this.fields.get("DEST_COUNTRY"),this.fields.get("DEST_REGION"),this.fields.get("DEST_CITY"),this.fields.get("DEST_BPADRESS"),this.fields.get("DEST_ADRESS_NOTE")] });
       this.layoutItems.add("Sender",
             { xtype:"fieldset", autoHeight:true,collapsible: true,title:this.resourceBundle.FieldsetTitle.Sender||"Sender",border:true,labelAlign:"left",width:"330"   ,items:[ this.fields.get("EXP_BPARTNER_ID"),this.fields.get("EXP_BPADRESS_ID"),this.fields.get("EXP_CITY_ID"),this.fields.get("EXP_NAME"),this.fields.get("EXP_COUNTRY"),this.fields.get("EXP_REGION"),this.fields.get("EXP_CITY"),this.fields.get("EXP_BPADRESS"),this.fields.get("EXP_ADRESS_NOTE")] });
       ...
       this.layoutItems.add("Notes",
             { xtype:"fieldset", autoHeight:true,collapsible: true,title:this.resourceBundle.FieldsetTitle.Notes||"Notes",border:true,labelAlign:"top",width:"230"   ,items:[ this.fields.get("CONTENT"),this.fields.get("NOTES")] });
       this.layoutItems.add("ParcelInfo",
             { xtype:"fieldset", autoHeight:true,collapsible: true,title:this.resourceBundle.FieldsetTitle.ParcelInfo||"ParcelInfo",border:true,labelAlign:"left",width:"230"   ,items:[ this.fields.get("ID"),this.fields.get("CLIENT_ID"),this.fields.get("CLIENT_CODE"),this.fields.get("CODE"),this.fields.get("PACKAGE_COUNT")] });
       this.layoutItems.add("C1",
             { layout:"form",width:260,labelAlign:"left",labelWidth:100, items:[ this.layoutItems.get("ParcelInfo"),this.layoutItems.get("Notes")]
 }); 
