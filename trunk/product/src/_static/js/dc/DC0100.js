    ...
    ,initComponent:function() {
       Ext.apply(this, {
           store: new Ext.data.JsonStore({
              ...
              ,root:"records"
              ,url:"frmMain.php?_p_action=fetch&_p_data_format=json&_p_form=DC0100"
              ,remoteSort :true
...
,"->","<span class='dcName'>DC0100</span>"          )
    ...
    this.colModel = new Ext.grid.ColumnModel (this.columnMap.getRange());
       ...
       this.queryFields.add("IS_CUSTOMER",new Ext.form.ComboBox({name:"QRY_IS_CUSTOMER",id:"DC0100F_QRY_IS_CUSTOMER",fieldLabel: this.resourceBundle.FieldLabel.IS_CUSTOMER||"Customer?",allowBlank:true,width:100,store:["Y","N"]}));
       this.queryFields.add("IS_VENDOR",new Ext.form.ComboBox({name:"QRY_IS_VENDOR",id:"DC0100F_QRY_IS_VENDOR",fieldLabel: this.resourceBundle.FieldLabel.IS_VENDOR||"Vendor?",allowBlank:true,width:100,store:["Y","N"]}));
       this.queryFields.add("IS_EMPLOYEE",new Ext.form.ComboBox({name:"QRY_IS_EMPLOYEE",id:"DC0100F_QRY_IS_EMPLOYEE",fieldLabel: this.resourceBundle.FieldLabel.IS_EMPLOYEE||"Employee?",allowBlank:true,width:100,store:["Y","N"]}));
