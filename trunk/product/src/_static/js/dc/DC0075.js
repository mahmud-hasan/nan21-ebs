 ...
 */
  ...
  N21.DataComp.DC0075 = Ext.extend(N21.Base.GridEdit, {
    ...
    this.colModel = new Ext.grid.ColumnModel (this.columnMap.getRange());
         ...
         this.queryFields.add("ID", new Ext.form.Hidden ({xtype: "hidden",name:"QRY_ID",id:"DC0075_QRY_ID",width:100,fieldLabel: this.resourceBundle.FieldLabel.ID||"Id"})  );
         this.queryFields.add("NAME", new Ext.form.TextField ({xtype: "textfield",name:"QRY_NAME",id:"DC0075_QRY_NAME",width:100,fieldLabel: this.resourceBundle.FieldLabel.NAME||"Name"})  );
