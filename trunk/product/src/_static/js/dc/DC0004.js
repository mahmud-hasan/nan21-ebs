 ...
 */ 
  ...
  N21.DataComp.DC0004G = Ext.extend(N21.Base.GridView, {
    ...
    ,initComponent:function() {
         ...
         this.queryFields.add("CLIENT_NAME", new N21.DataComp.LOV0008({xtype: "LOV0008",fieldMapping: [{column:"ID",field:"DC0004_QRY_CLIENT_ID"}],name:"QRY_CLIENT_NAME",id:"DC0004_QRY_CLIENT_NAME",width:100,fieldLabel: this.resourceBundle.FieldLabel.CLIENT_NAME||"Client"})  );
         ...
         this.queryFields.add("RECEIVER_NAME", new N21.DataComp.LOV0041({xtype: "LOV0041",fieldMapping: [{column:"ID",field:"DC0004_QRY_RECEIVER_ID"}],selectOnFocus:true,name:"QRY_RECEIVER_NAME",id:"DC0004_QRY_RECEIVER_NAME",width:100,fieldLabel: this.resourceBundle.FieldLabel.RECEIVER_NAME||"Receiver"})  );
 ...
 */ 
  ...
  N21.DataComp.DC0004F = Ext.extend(N21.Base.EditForm, {
    ...
    ,initComponent:function() {
       ...
       this.fields.add("DOC_TYPE", new N21.DataComp.LOV0003({xtype: "LOV0003",selectOnFocus:true,name:"DOC_TYPE",id:"DC0004F_DOC_TYPE",dataIndex:"DOC_TYPE",width:80,listWidth:98,allowBlank:true,fieldLabel: this.resourceBundle.FieldLabel.DOC_TYPE||"Inv. type",insert_allowed:true,update_allowed:true})   );
       this.fields.add("DOC_CURRENCY", new N21.DataComp.LOV0001({xtype: "LOV0001",selectOnFocus:true,name:"DOC_CURRENCY",id:"DC0004F_DOC_CURRENCY",dataIndex:"DOC_CURRENCY",width:80,listWidth:98,allowBlank:true,fieldLabel: this.resourceBundle.FieldLabel.DOC_CURRENCY||"Currency",insert_allowed:true,update_allowed:true})   );
       this.fields.add("DOC_NO_SERIAL", new Ext.form.TextField ({xtype: "textfield",name:"DOC_NO_SERIAL",id:"DC0004F_DOC_NO_SERIAL",dataIndex:"DOC_NO_SERIAL",width:100,allowBlank:true,fieldLabel: this.resourceBundle.FieldLabel.DOC_NO_SERIAL||"Serial no",insert_allowed:true,update_allowed:true})   );
       this.fields.add("DOC_NO", new Ext.form.TextField ({xtype: "textfield",name:"DOC_NO",id:"DC0004F_DOC_NO",dataIndex:"DOC_NO",width:100,allowBlank:false,labelSeparator:":*" ,fieldLabel: this.resourceBundle.FieldLabel.DOC_NO||"Doc no",insert_allowed:true,update_allowed:true})   );
       ...
       this.fields.add("RECEIVER_NAME", new N21.DataComp.LOV0041({xtype: "LOV0041",fieldMapping: [{column:"ID",field:"DC0004F_RECEIVER_ID"},{column:"ACCT",field:"DC0004F_ACCT"}],selectOnFocus:true,name:"RECEIVER_NAME",id:"DC0004F_RECEIVER_NAME",dataIndex:"RECEIVER_NAME",width:150,allowBlank:false,labelSeparator:":*" ,fieldLabel: this.resourceBundle.FieldLabel.RECEIVER_NAME||"Receiver",insert_allowed:true,update_allowed:true})   );
       ...
       this.fields.add("CREATEDON", new Ext.form.DateField ({xtype: "datefield",name:"CREATEDON",id:"DC0004F_CREATEDON",dataIndex:"CREATEDON",width:80,allowBlank:true,fieldLabel: this.resourceBundle.FieldLabel.CREATEDON||"CreatedOn",disabled:true,format:Ext.DATE_FORMAT})   );
       ...
       this.fields.add("MODIFIEDON", new Ext.form.DateField ({xtype: "datefield",name:"MODIFIEDON",id:"DC0004F_MODIFIEDON",dataIndex:"MODIFIEDON",width:80,allowBlank:true,fieldLabel: this.resourceBundle.FieldLabel.MODIFIEDON||"ModifiedOn",disabled:true,format:Ext.DATE_FORMAT})   );
       ...
       this.fields.add("POSTEDON", new Ext.form.DateField ({xtype: "datefield",name:"POSTEDON",id:"DC0004F_POSTEDON",dataIndex:"POSTEDON",width:80,allowBlank:true,fieldLabel: this.resourceBundle.FieldLabel.POSTEDON||"Postedon",disabled:true,format:Ext.DATE_FORMAT})   );
       ...
       this.fields.add("ACCDOC_NAME", new Ext.form.TextField ({xtype: "textfield",name:"ACCDOC_NAME",id:"DC0004F_ACCDOC_NAME",dataIndex:"ACCDOC_NAME",width:100,allowBlank:true,fieldLabel: this.resourceBundle.FieldLabel.ACCDOC_NAME||"Accdoc",disabled:true})   );
       ...
       this.layoutItems.add("InvAmounts",
             { xtype:"fieldset", autoHeight:true,collapsible: true,title:this.resourceBundle.FieldsetTitle.InvAmounts||"InvAmounts",border:true,labelAlign:"left",width:"250"   ,items:[ this.fields.get("DOC_CURRENCY"),this.fields.get("TOTAL_AMOUNT"),this.fields.get("TOTAL_NET_AMOUNT"),this.fields.get("TOTAL_TAX_AMOUNT"),this.fields.get("CURRENCY_XRATE")] });
       ...
       this.layoutItems.add("DC0042",
             new Ext.Window({ xtype:"window", modal:true, title: "DC0042 - "+(N21.DataComp.DC0042.prototype.resourceBundle.DcProperty.Title||"Window"),  closeAction:"hide",closable:true,layout:"fit", width:700, height:450, items:{xtype:"DC0042",id:"DC0042", parentDcRelation:{name:"DC0004F",relation:[{parent:"ACCDOC_ID",child:"ACCDOC_ID"}]}         }} ) ); 
       this.layoutItems.add("Status",
             { xtype:"fieldset", autoHeight:true,collapsible: true,title:this.resourceBundle.FieldsetTitle.Status||"Status",border:true,labelAlign:"left",width:"220"   ,items:[ this.fields.get("IS_INSERTED"),this.fields.get("IS_PRINTED"),this.fields.get("IS_POSTED"),this.fields.get("ACCDOC_ID"),this.fields.get("ACCDOC_NAME")] });
       this.layoutItems.add("Modified",
             { xtype:"fieldset", autoHeight:true,collapsed:true,collapsible: true,title:this.resourceBundle.FieldsetTitle.Modified||"Modified",border:true,labelAlign:"left",width:"220"   ,items:[ this.fields.get("CREATEDON"),this.fields.get("CREATEDBY"),this.fields.get("MODIFIEDON"),this.fields.get("MODIFIEDBY"),this.fields.get("POSTEDON"),this.fields.get("POSTEDBY")] });
       ...
       this.layoutItems.add("DocInfo",
             { xtype:"fieldset", autoHeight:true,collapsible: true,title:this.resourceBundle.FieldsetTitle.DocInfo||"DocInfo",border:true,labelAlign:"left",width:"300"   ,items:[ this.fields.get("CLIENT_NAME"),this.fields.get("ISSUER_NAME"),this.fields.get("DOC_DATE"),this.fields.get("DOC_TYPE"),this.fields.get("DOC_NO_SERIAL"),this.fields.get("DOC_NO"),this.fields.get("DUE_DATE")] });
       this.layoutItems.add("Receiver",
             { xtype:"fieldset", autoHeight:true,collapsible: true,title:this.resourceBundle.FieldsetTitle.Receiver||"Receiver",border:true,labelAlign:"left",width:"300"   ,items:[ this.fields.get("RECEIVER_ID"),this.fields.get("RECEIVER_NAME"),this.fields.get("ACCT")] });
