    ...
    ,initComponent:function() {
       Ext.apply(this, {
          ...
          ,columns: [new Ext.grid.RowNumberer(),
              ...
              ,{ id:"TOTAL_NET_AMOUNT",header:this.resourceBundle.FieldLabel.TOTAL_NET_AMOUNT||"Total_net_amount",width:100,dataIndex:'TOTAL_NET_AMOUNT',sortable:true,align:'right',decimalPrecision:2}
              ,{ id:"TOTAL_TAX_AMOUNT",header:this.resourceBundle.FieldLabel.TOTAL_TAX_AMOUNT||"Total_tax_amount",width:100,dataIndex:'TOTAL_TAX_AMOUNT',sortable:true,align:'right',decimalPrecision:2}
          ...
          ,queryFields: [
                {xtype: "hidden",name:"QRY_ID",id:"DC0026_QRY_ID",width:120,fieldLabel: this.resourceBundle.FieldLabel.ID||"Id"}
               ,{xtype: "hidden",name:"QRY_CLIENT_ID",id:"DC0026_QRY_CLIENT_ID",width:120,fieldLabel: this.resourceBundle.FieldLabel.CLIENT_ID||"Client_id"}
               ,{xtype: "LOV0008",displayColumn: "CODE",name:"QRY_CLIENT_NAME",id:"DC0026_QRY_CLIENT_NAME",width:120,fieldLabel: this.resourceBundle.FieldLabel.CLIENT_NAME||"Client"}
               ,{xtype: "hidden",name:"QRY_RECEIVER_ID",id:"DC0026_QRY_RECEIVER_ID",width:120,fieldLabel: this.resourceBundle.FieldLabel.RECEIVER_ID||"Receiver_id"}
               ,{xtype: "LOV0015",displayColumn: "CODE",name:"QRY_DOC_TYPE",id:"DC0026_QRY_DOC_TYPE",width:120,fieldLabel: this.resourceBundle.FieldLabel.DOC_TYPE||"Doc_type"}
               ,{xtype: "textfield",name:"QRY_DOC_NO",id:"DC0026_QRY_DOC_NO",width:120,fieldLabel: this.resourceBundle.FieldLabel.DOC_NO||"Doc_no"}
               ,{xtype: "datefield",name:"QRY_DOC_DATE",id:"DC0026_QRY_DOC_DATE",width:120,fieldLabel: this.resourceBundle.FieldLabel.DOC_DATE||"Doc_date",format:Ext.DATE_FORMAT}
               ,{xtype: "hidden",name:"QRY_ISSUER_ID",id:"DC0026_QRY_ISSUER_ID",width:120,fieldLabel: this.resourceBundle.FieldLabel.ISSUER_ID||"Issuer_id"}
               ,{xtype: "LOV0042",displayColumn: "NAME",fieldMapping: [{column:"ID",field:"DC0026_QRY_ISSUER_ID"},{column:"ACCT",field:"DC0026_QRY_ACCT"}],selectOnFocus:true,name:"QRY_ISSUER_NAME",id:"DC0026_QRY_ISSUER_NAME",width:120,fieldLabel: this.resourceBundle.FieldLabel.ISSUER_NAME||"Issuer"}
               ,{xtype: "hidden",name:"QRY_ACCDOC_ID",id:"DC0026_QRY_ACCDOC_ID",width:120,fieldLabel: this.resourceBundle.FieldLabel.ACCDOC_ID||"Accdoc_id"}
               ,{xtype: "hidden",name:"QRY_REF_RINVOICE_ID",id:"DC0026_QRY_REF_RINVOICE_ID",width:120,fieldLabel: this.resourceBundle.FieldLabel.REF_RINVOICE_ID||"Ref_rinvoice_id"}
               ,{xtype: "textfield",name:"QRY_INSERTEDBY",id:"DC0026_QRY_INSERTEDBY",width:120,fieldLabel: this.resourceBundle.FieldLabel.INSERTEDBY||"Registered by"}
               ,{xtype: "datefield",name:"QRY_INSERTEDON",id:"DC0026_QRY_INSERTEDON",width:120,fieldLabel: this.resourceBundle.FieldLabel.INSERTEDON||"Registered on",format:Ext.DATE_FORMAT}
          ]
 ...
 */ 
  ...
  N21.DataComp.DC0026F = Ext.extend(N21.Base.EditForm, {
    ...
    ,initComponent:function() {
       ...
       this.fields.add("DOC_TYPE", new N21.DataComp.LOV0015({xtype: "LOV0015",displayColumn: "CODE",selectOnFocus:true,name:"DOC_TYPE",id:"DC0026F_DOC_TYPE",dataIndex:"DOC_TYPE",width:120,allowBlank:false,labelSeparator:":*" ,fieldLabel: this.resourceBundle.FieldLabel.DOC_TYPE||"Doc_type",insert_allowed:true,update_allowed:true})   );
       this.fields.add("DOC_NO", new Ext.form.TextField ({xtype: "textfield",name:"DOC_NO",id:"DC0026F_DOC_NO",dataIndex:"DOC_NO",width:120,allowBlank:false,labelSeparator:":*" ,fieldLabel: this.resourceBundle.FieldLabel.DOC_NO||"Doc_no",insert_allowed:true,update_allowed:true})   );
       this.fields.add("DOC_DATE", new Ext.form.DateField ({xtype: "datefield",name:"DOC_DATE",id:"DC0026F_DOC_DATE",dataIndex:"DOC_DATE",width:100,allowBlank:false,labelSeparator:":*" ,fieldLabel: this.resourceBundle.FieldLabel.DOC_DATE||"Doc_date",insert_allowed:true,update_allowed:true,format:Ext.DATE_FORMAT})   );
       ...
       this.fields.add("TOTAL_AMOUNT", new Ext.form.NumberField ({xtype: "numberfield",name:"TOTAL_AMOUNT",id:"DC0026F_TOTAL_AMOUNT",dataIndex:"TOTAL_AMOUNT",width:100,allowBlank:false,labelSeparator:":*" ,fieldLabel: this.resourceBundle.FieldLabel.TOTAL_AMOUNT||"Total_amount",insert_allowed:true,update_allowed:true,decimalPrecision:2,style: "text-align:right;",fieldClass: "field_important_1",listeners:{  "change":{scope:this, fn:this.change_TOTAL_AMOUNT}  }})   );
       this.fields.add("TOTAL_NET_AMOUNT", new Ext.form.NumberField ({xtype: "numberfield",name:"TOTAL_NET_AMOUNT",id:"DC0026F_TOTAL_NET_AMOUNT",dataIndex:"TOTAL_NET_AMOUNT",width:100,allowBlank:false,labelSeparator:":*" ,fieldLabel: this.resourceBundle.FieldLabel.TOTAL_NET_AMOUNT||"Total_net_amount",insert_allowed:true,update_allowed:true,decimalPrecision:2,style: "text-align:right;"})   );
       this.fields.add("TOTAL_TAX_AMOUNT", new Ext.form.NumberField ({xtype: "numberfield",name:"TOTAL_TAX_AMOUNT",id:"DC0026F_TOTAL_TAX_AMOUNT",dataIndex:"TOTAL_TAX_AMOUNT",width:100,allowBlank:false,labelSeparator:":*" ,fieldLabel: this.resourceBundle.FieldLabel.TOTAL_TAX_AMOUNT||"Total_tax_amount",insert_allowed:true,update_allowed:true,decimalPrecision:2,style: "text-align:right;"})   );
       this.fields.add("DUE_DATE", new Ext.form.DateField ({xtype: "datefield",name:"DUE_DATE",id:"DC0026F_DUE_DATE",dataIndex:"DUE_DATE",width:100,allowBlank:true,fieldLabel: this.resourceBundle.FieldLabel.DUE_DATE||"Due_date",insert_allowed:true,update_allowed:true,format:Ext.DATE_FORMAT})   );
       ...
       this.fields.add("ACCDOC_NAME", new Ext.form.TextField ({xtype: "textfield",name:"ACCDOC_NAME",id:"DC0026F_ACCDOC_NAME",dataIndex:"ACCDOC_NAME",width:150,allowBlank:false,labelSeparator:":*" ,fieldLabel: this.resourceBundle.FieldLabel.ACCDOC_NAME||"Accdoc",disabled:true})   );
       this.fields.add("ACCDOC_ID", new Ext.form.Hidden ({xtype: "hidden",name:"ACCDOC_ID",id:"DC0026F_ACCDOC_ID",dataIndex:"ACCDOC_ID",width:100,allowBlank:true,fieldLabel: this.resourceBundle.FieldLabel.ACCDOC_ID||"Accdoc_id",insert_allowed:true,update_allowed:true})   );
