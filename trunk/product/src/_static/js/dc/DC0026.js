 ...
 */ 
  ...
  N21.DataComp.DC0026F = Ext.extend(N21.Base.EditForm, {
    ...
    ,initComponent:function() {
       ...
       this.fields.add("IS_INSERTED",new Ext.ux.form.XCheckbox({name:"IS_INSERTED",id:"DC0026F_IS_INSERTED",dataIndex:"IS_INSERTED",fieldLabel: this.resourceBundle.FieldLabel.IS_INSERTED||"Registered",allowBlank:true,width:50,insert_allowed:true,update_allowed:true}));
       this.fields.add("IS_PAYABLE",new Ext.ux.form.XCheckbox({name:"IS_PAYABLE",id:"DC0026F_IS_PAYABLE",dataIndex:"IS_PAYABLE",fieldLabel: this.resourceBundle.FieldLabel.IS_PAYABLE||"Is_payable",allowBlank:true,width:50,insert_allowed:true,update_allowed:true}));
       this.fields.add("IS_PAYED",new Ext.ux.form.XCheckbox({name:"IS_PAYED",id:"DC0026F_IS_PAYED",dataIndex:"IS_PAYED",fieldLabel: this.resourceBundle.FieldLabel.IS_PAYED||"Is_payed",allowBlank:true,width:50,insert_allowed:true,update_allowed:true}));
       ...
       this.fields.add("CREATEDON",new Ext.form.DateField({name:"CREATEDON",id:"DC0026F_CREATEDON",dataIndex:"CREATEDON",fieldLabel: this.resourceBundle.FieldLabel.CREATEDON||"CreatedOn",allowBlank:true,width:80,disabled:true,format:Ext.DATE_FORMAT}));
       ...
       this.fields.add("MODIFIEDON",new Ext.form.DateField({name:"MODIFIEDON",id:"DC0026F_MODIFIEDON",dataIndex:"MODIFIEDON",fieldLabel: this.resourceBundle.FieldLabel.MODIFIEDON||"ModifiedOn",allowBlank:true,width:80,disabled:true,format:Ext.DATE_FORMAT}));
       ...
       this.layoutItems.add("ProcessingStatus",
             { xtype:"fieldset", autoHeight:true,collapsible: true,title:this.resourceBundle.FieldsetTitle.ProcessingStatus||"ProcessingStatus",border:true,labelAlign:"left",width:"240"   ,items:[ this.fields.get("IS_INSERTED"),this.fields.get("IS_PAYABLE"),this.fields.get("IS_PAYED")] });
