 ...
 */ 
  ...
  N21.DataComp.DC0026G = Ext.extend(N21.Base.GridView, {
    ...
    ,initComponent:function() {
         ...
         this.queryFields.add("CLIENT_NAME", new N21.DataComp.LOV0008({xtype: "LOV0008",displayColumn: "CODE",fieldMapping: [{column:"ID",field:"DC0026_QRY_CLIENT_ID"}],name:"QRY_CLIENT_NAME",id:"DC0026_QRY_CLIENT_NAME",width:100,fieldLabel: this.resourceBundle.FieldLabel.CLIENT_NAME||"Client"})  );
         ...
         this.queryFields.add("ISSUER_NAME", new N21.DataComp.LOV0042({xtype: "LOV0042",displayColumn: "NAME",fieldMapping: [{column:"ID",field:"DC0026_QRY_ISSUER_ID"}],selectOnFocus:true,name:"QRY_ISSUER_NAME",id:"DC0026_QRY_ISSUER_NAME",width:100,fieldLabel: this.resourceBundle.FieldLabel.ISSUER_NAME||"Issuer"})  );
 ...
 */ 
  ...
  N21.DataComp.DC0026F = Ext.extend(N21.Base.EditForm, {
    ...
    ,initComponent:function() {
       ...
       this.fields.add("DOC_TYPE", new N21.DataComp.LOV0015({xtype: "LOV0015",displayColumn: "CODE",selectOnFocus:true,name:"DOC_TYPE",id:"DC0026F_DOC_TYPE",dataIndex:"DOC_TYPE",width:120,listWidth:138,allowBlank:false,labelSeparator:":*" ,fieldLabel: this.resourceBundle.FieldLabel.DOC_TYPE||"Doc type",insert_allowed:true,update_allowed:true})   );
       ...
       this.fields.add("ISSUER_NAME", new N21.DataComp.LOV0042({xtype: "LOV0042",displayColumn: "NAME",fieldMapping: [{column:"ID",field:"DC0026F_ISSUER_ID"},{column:"ACCT",field:"DC0026F_ACCT"}],selectOnFocus:true,name:"ISSUER_NAME",id:"DC0026F_ISSUER_NAME",dataIndex:"ISSUER_NAME",width:150,allowBlank:false,labelSeparator:":*" ,fieldLabel: this.resourceBundle.FieldLabel.ISSUER_NAME||"Issuer",insert_allowed:true,update_allowed:true})   );
       ...
       this.fields.add("ACCDOC_NAME", new Ext.form.TextField ({xtype: "textfield",name:"ACCDOC_NAME",id:"DC0026F_ACCDOC_NAME",dataIndex:"ACCDOC_NAME",width:120,allowBlank:false,labelSeparator:":*" ,fieldLabel: this.resourceBundle.FieldLabel.ACCDOC_NAME||"Acc. doc",disabled:true})   );
       ...
       this.fields.add("INSERTEDON", new Ext.form.DateField ({xtype: "datefield",name:"INSERTEDON",id:"DC0026F_INSERTEDON",dataIndex:"INSERTEDON",width:80,allowBlank:true,fieldLabel: this.resourceBundle.FieldLabel.INSERTEDON||"Registered on",disabled:true,format:Ext.DATE_FORMAT})   );
       this.fields.add("CREATEDON", new Ext.form.DateField ({xtype: "datefield",name:"CREATEDON",id:"DC0026F_CREATEDON",dataIndex:"CREATEDON",width:80,allowBlank:true,fieldLabel: this.resourceBundle.FieldLabel.CREATEDON||"CreatedOn",disabled:true,format:Ext.DATE_FORMAT})   );
       ...
       this.fields.add("MODIFIEDON", new Ext.form.DateField ({xtype: "datefield",name:"MODIFIEDON",id:"DC0026F_MODIFIEDON",dataIndex:"MODIFIEDON",width:80,allowBlank:true,fieldLabel: this.resourceBundle.FieldLabel.MODIFIEDON||"ModifiedOn",disabled:true,format:Ext.DATE_FORMAT})   );
       ...
       this.fields.add("POSTEDON", new Ext.form.DateField ({xtype: "datefield",name:"POSTEDON",id:"DC0026F_POSTEDON",dataIndex:"POSTEDON",width:80,allowBlank:true,fieldLabel: this.resourceBundle.FieldLabel.POSTEDON||"Postedon",disabled:true,format:Ext.DATE_FORMAT})   );
       ...
       this.layoutItems.add("DC0042",
             new Ext.Window({ xtype:"window", modal:true, title: "DC0042 - "+(N21.DataComp.DC0042.prototype.resourceBundle.DcProperty.Title||"WINDOW"),  closeAction:"hide",closable:true,layout:"fit", width:600, height:450, items:{xtype:"DC0042",id:"DC0042", parentDcRelation:{name:"DC0026F",relation:[{parent:"ACCDOC_ID",child:"ACCDOC_ID"}]}         }} ) ); 
       this.layoutItems.add("Amounts",
             { xtype:"fieldset", autoHeight:true,collapsible: true,title:this.resourceBundle.FieldsetTitle.Amounts||"Amounts",border:true,labelAlign:"left",width:"240"   ,items:[ this.fields.get("DOC_CURRENCY"),this.fields.get("TOTAL_AMOUNT"),this.fields.get("TOTAL_NET_AMOUNT"),this.fields.get("TOTAL_TAX_AMOUNT")] });
       this.layoutItems.add("ProcessingStatus",
             { xtype:"fieldset", autoHeight:true,collapsible: true,title:this.resourceBundle.FieldsetTitle.ProcessingStatus||"ProcessingStatus",border:true,labelAlign:"left",width:"240"   ,items:[ this.fields.get("IS_INSERTED"),this.fields.get("IS_PAYABLE"),this.fields.get("IS_PAYED"),this.fields.get("IS_POSTED"),this.fields.get("ACCDOC_ID"),this.fields.get("ACCDOC_NAME")] });
       ...
       this.layoutItems.add("Unit",
             { xtype:"fieldset", autoHeight:true,collapsible: true,title:this.resourceBundle.FieldsetTitle.Unit||"Unit",border:true,labelAlign:"left",width:"300"   ,items:[ this.fields.get("CLIENT_ID"),this.fields.get("CLIENT_NAME"),this.fields.get("RECEIVER_ID"),this.fields.get("RECEIVER_NAME")] });
