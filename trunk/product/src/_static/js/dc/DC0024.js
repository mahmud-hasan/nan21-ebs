 ...
 */ 
  ...
  N21.DataComp.DC0024G = Ext.extend(N21.Base.GridView, {
    ...
    ,initComponent:function() {
       ...
       this.queryFields.add("CODE",new Ext.form.TextField({name:"QRY_CODE",id:"DC0024F_QRY_CODE",fieldLabel: this.resourceBundle.FieldLabel.CODE||"Code",allowBlank:true,style: "text-transform:uppercase;",width:100}));
       this.queryFields.add("CLOSED",new Ext.form.ComboBox({name:"QRY_CLOSED",id:"DC0024F_QRY_CLOSED",fieldLabel: this.resourceBundle.FieldLabel.CLOSED||"Closed",allowBlank:true,width:40,store:["Y","N"]}));
       ...
       Ext.apply(this, {
          ...
          ,columns: [new Ext.grid.RowNumberer(),
              ...
              ,{ id:"IS_FIRST_PERIOD",header:this.resourceBundle.FieldLabel.IS_FIRST_PERIOD||"Is first period?",width:100,dataIndex:'IS_FIRST_PERIOD',sortable:true}
 ...
 */ 
  ...
  N21.DataComp.DC0024F = Ext.extend(N21.Base.EditForm, {
    ...
    ,initComponent:function() {
       ...
       this.fields.add("CODE",new Ext.form.TextField({name:"CODE",id:"DC0024F_CODE",dataIndex:"CODE",fieldLabel: this.resourceBundle.FieldLabel.CODE||"Code",allowBlank:false,labelSeparator:":*",width:150,insert_allowed:true,update_allowed:true,style: "text-transform:uppercase;"}));
       ...
       this.fields.add("OPENED",new Ext.ux.form.XCheckbox({name:"OPENED",id:"DC0024F_OPENED",dataIndex:"OPENED",fieldLabel: this.resourceBundle.FieldLabel.OPENED||"Opened",allowBlank:true,width:50,insert_allowed:false,update_allowed:false}));
       this.fields.add("CLOSED",new Ext.ux.form.XCheckbox({name:"CLOSED",id:"DC0024F_CLOSED",dataIndex:"CLOSED",fieldLabel: this.resourceBundle.FieldLabel.CLOSED||"Closed",allowBlank:true,width:50,insert_allowed:false,update_allowed:false}));
       ...
       this.fields.add("IS_FIRST_PERIOD",new Ext.ux.form.XCheckbox({name:"IS_FIRST_PERIOD",id:"DC0024F_IS_FIRST_PERIOD",dataIndex:"IS_FIRST_PERIOD",fieldLabel: this.resourceBundle.FieldLabel.IS_FIRST_PERIOD||"Is first period?",allowBlank:true,width:30,insert_allowed:true,update_allowed:true}));
