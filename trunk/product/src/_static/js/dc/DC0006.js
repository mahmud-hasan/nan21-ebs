...
,"->","<span class='dcName'>DC0006</span>"          )
    ...
    this.colModel = new Ext.grid.ColumnModel (this.columnMap.getRange());
       ...
       this.queryFields.add("BANK_CODE",new  N21.DataComp.LOV0005({name:"QRY_BANK_CODE",id:"DC0006F_QRY_BANK_CODE",fieldLabel: this.resourceBundle.FieldLabel.BANK_CODE||"Bank_code",allowBlank:true,width:100,listWidth:118,selectOnFocus:true}));
       this.queryFields.add("CODE",new Ext.form.TextField({name:"QRY_CODE",id:"DC0006F_QRY_CODE",fieldLabel: this.resourceBundle.FieldLabel.CODE||"Code",allowBlank:true,width:100}));
