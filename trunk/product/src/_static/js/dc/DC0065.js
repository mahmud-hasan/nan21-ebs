  ...
  N21.DataComp.DC0065 = Ext.extend(N21.Base.GridEdit, {
    ...
    ,initComponent:function() {
       Ext.apply(this, {
         ...
         this.columnMap.add("DOCUMENT_TYPE",{ id:'DOCUMENT_TYPE',header:this.resourceBundle.FieldLabel.DOCUMENT_TYPE||"Doc. type",width:100,dataIndex:'DOCUMENT_TYPE',insert_allowed:true,update_allowed:true,sortable:true,editor:new Ext.form.TextField({selectOnFocus:true,allowBlank: false,cls:"x-form-text-in-grid"})});
