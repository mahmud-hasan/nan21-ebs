 ...
 */
  ...
  N21.DataComp.DC0071 = Ext.extend(N21.Base.GridEdit, {
    ...
    ,initComponent:function() {
         ...
         this.columns.add("FETCH_ALLOWED",{ id:'FETCH_ALLOWED',header:this.resourceBundle.FieldLabel.FETCH_ALLOWED||"Query allowed",width:40,dataIndex:'FETCH_ALLOWED',insert_allowed:true,update_allowed:true,sortable:true,editor:new Ext.form.ComboBox({ store:["N","Y"],selectOnFocus:true,allowBlank: false,cls:"x-form-text-in-grid"})});
         this.columns.add("INSERT_ALLOWED",{ id:'INSERT_ALLOWED',header:this.resourceBundle.FieldLabel.INSERT_ALLOWED||"Insert allowed",width:40,dataIndex:'INSERT_ALLOWED',insert_allowed:true,update_allowed:true,sortable:true,editor:new Ext.form.ComboBox({ store:["N","Y"],selectOnFocus:true,allowBlank: false,cls:"x-form-text-in-grid"})});
         this.columns.add("UPDATE_ALLOWED",{ id:'UPDATE_ALLOWED',header:this.resourceBundle.FieldLabel.UPDATE_ALLOWED||"Update allowed",width:40,dataIndex:'UPDATE_ALLOWED',insert_allowed:true,update_allowed:true,sortable:true,editor:new Ext.form.ComboBox({ store:["N","Y"],selectOnFocus:true,allowBlank: false,cls:"x-form-text-in-grid"})});
         this.columns.add("DELETE_ALLOWED",{ id:'DELETE_ALLOWED',header:this.resourceBundle.FieldLabel.DELETE_ALLOWED||"Delete allowed",width:40,dataIndex:'DELETE_ALLOWED',insert_allowed:true,update_allowed:true,sortable:true,editor:new Ext.form.ComboBox({ store:["N","Y"],selectOnFocus:true,allowBlank: false,cls:"x-form-text-in-grid"})});
         this.columns.add("CREATEDON",{ id:'CREATEDON',header:this.resourceBundle.FieldLabel.CREATEDON||"Created on",width:100,dataIndex:'CREATEDON',insert_allowed:true,update_allowed:false,hidden:true,sortable:true,renderer:Ext.util.Format.dateRenderer(Ext.DATE_FORMAT)});
         this.columns.add("CREATEDBY",{ id:'CREATEDBY',header:this.resourceBundle.FieldLabel.CREATEDBY||"Created by",width:100,dataIndex:'CREATEDBY',insert_allowed:true,update_allowed:false,hidden:true,sortable:true});
         this.columns.add("MODIFIEDON",{ id:'MODIFIEDON',header:this.resourceBundle.FieldLabel.MODIFIEDON||"Modified on",width:100,dataIndex:'MODIFIEDON',insert_allowed:true,update_allowed:false,hidden:true,sortable:true,renderer:Ext.util.Format.dateRenderer(Ext.DATE_FORMAT)});
         this.columns.add("MODIFIEDBY",{ id:'MODIFIEDBY',header:this.resourceBundle.FieldLabel.MODIFIEDBY||"Modified by",width:100,dataIndex:'MODIFIEDBY',insert_allowed:true,update_allowed:false,hidden:true,sortable:true});
       ...
       Ext.apply(this, {
          ...
          ,columns: [ this.columns.get("ID"),this.columns.get("UI_DC"),this.columns.get("ROLE_NAME"),this.columns.get("FETCH_ALLOWED"),this.columns.get("INSERT_ALLOWED"),this.columns.get("UPDATE_ALLOWED"),this.columns.get("DELETE_ALLOWED"),this.columns.get("CREATEDON"),this.columns.get("CREATEDBY"),this.columns.get("MODIFIEDON"),this.columns.get("MODIFIEDBY")]
          ,tbar: new Array(
