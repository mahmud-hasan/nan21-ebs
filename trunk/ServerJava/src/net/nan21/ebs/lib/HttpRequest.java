...
public class HttpRequest {
	...
	public static final String REQUEST_PARAM_FETCH_DATA_FORMAT = "_p_data_format";
	public static final String REQUEST_PARAM_EXPORT_DATA_FORMAT = "_p_exp_format";
	public static final String REQUEST_PARAM_DC = "_p_form";
	...
	public static final String ACTION_INIT_RECORD = "initRec";
	...
	public boolean isValid() {
		if (this.isAuthenticationRequest()) {
			...
			return this.isValidProcessingRequest();
		}	
	}
	...
	private boolean isValidProcessingRequest() {
		// Action specified ?
		if (this.httpServletRequest.getParameter(REQUEST_PARAM_ACTION) ==null ) {
