...
public class LOV0048 extends AbstractDataControl implements IDataControlLov {
...
private void preQuery() {
  ...
  public void doQuery() throws Exception {
      ...
      String sql = "select tsql.* from (select id, code, name from cost_center where client_id = :p_client_id) tsql " + this.queryWhere.toString() + " " + this.queryOrderBy;
