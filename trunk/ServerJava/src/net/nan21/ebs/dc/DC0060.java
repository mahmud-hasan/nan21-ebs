...
public void doQuery() throws Exception {
    ...
    String sql = "select "+ 
               " ol.CURRENCY_CODE"+
               " ,to_char(ol.DATE_DELIVERED,'"+this.DATE_FORMAT_DB+"') DATE_DELIVERED"+
               " ,to_char(ol.DATE_PROMISED,'"+this.DATE_FORMAT_DB+"') DATE_PROMISED"+
               " ,to_char(ol.DATE_REQUESTED,'"+this.DATE_FORMAT_DB+"') DATE_REQUESTED"+
               " ,ol.DISCOUNT"+
               " ,ol.DISCOUNT_TYPE"+
               " ,ol.ID"+
               " ,ol.LINE_NR"+
