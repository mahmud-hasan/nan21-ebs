 ...
 * Generated content.
 * DC0086 DC Controller: Org. inventory type
 */
...
public void doQuery() throws Exception {
    ...
    String sql = "select "+ 
               ...
               " ,t.MODIFIEDON"+
               " ,t.MODIFIEDBY"+
           " from MM_ORG_INV_TYPE t "+this.queryWhere.toString()+" "+this.queryOrderBy;
...
public void doInsert()  throws Exception {
  ...
  this.populateRecordWithClientSpecific();
    String sql = "insert into MM_ORG_INV_TYPE("+
               "  ID"+
               " ,CODE"+
               " ,DESCRIPTION"+
           " ) values ( "+
...
public void doUpdate()  throws Exception {
    this.populateRecordFromRequest();
    this.populateRecordWithClientSpecific();
    String sql = "update MM_ORG_INV_TYPE set "+
               "  CODE=:CODE"+ 
               " ,CREATEDBY=:CREATEDBY"+ 
               " ,CREATEDON=:CREATEDON"+ 
...
public void doDelete() throws Exception {
    this.populateRecordPkFromRequest();
   String sql = "delete from MM_ORG_INV_TYPE where "+
     "      ID= :ID"+
    "";
