 ...
 * Generated content.
 * DC0053 DC Controller: Project status def.
 */
...
public void doQuery() throws Exception {
    ...
    String sql = "select "+ 
               ...
               " ,ID"+
               " ,NAME"+
           " from PROJECT_STATUS  "+this.queryWhere.toString()+" "+this.queryOrderBy;
...
public void doInsert()  throws Exception {
  ...
  this.populateRecordWithClientSpecific();
    String sql = "insert into PROJECT_STATUS("+
               "  CODE"+
               " ,ID"+
               " ,NAME"+
           " ) values ( "+
...
public void doUpdate()  throws Exception {
    this.populateRecordFromRequest();
    this.populateRecordWithClientSpecific();
    String sql = "update PROJECT_STATUS set "+
               "  CODE=:CODE"+ 
               " ,ID=:ID"+ 
               " ,NAME=:NAME"+ 
   " where "+ 
...
public void doDelete() throws Exception {
    this.populateRecordPkFromRequest();
   String sql = "delete from PROJECT_STATUS where "+
     "      ID= :ID"+
    "";
