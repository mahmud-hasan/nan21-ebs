...
public void doQuery() throws Exception {
    ...
    String sql = "select "+ 
               " pol.CURRENCY_CODE"+
               " ,to_char(pol.DATE_DELIVERED,'"+this.DATE_FORMAT_DB+"') DATE_DELIVERED"+
               " ,to_char(pol.DATE_PROMISED,'"+this.DATE_FORMAT_DB+"') DATE_PROMISED"+
               " ,to_char(pol.DATE_REQUESTED,'"+this.DATE_FORMAT_DB+"') DATE_REQUESTED"+
               " ,pol.ID"+
               " ,pol.LINE_NR"+
               " ,pol.NET_AMOUNT"+
               " ,pol.NOTES"+
