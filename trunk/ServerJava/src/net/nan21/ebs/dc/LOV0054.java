...
public class LOV0054 extends AbstractDataControl implements IDataControlLov {
...
private void preQuery() {
  ...
  public void doQuery() throws Exception {
      ...
      String sql = "select tsql.* from (select code from mm_stock_loc_type order by 1) tsql " + this.queryWhere.toString() + " " + this.queryOrderBy;
