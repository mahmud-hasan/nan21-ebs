...
public class LOV0041 extends AbstractDataControl implements IDataControlLov {
...
private void preQuery() {
  ...
  public void doQuery() throws Exception {
      ...
      String sql = "select tsql.* from (select bp.id id, bp.code code, bp.name name"+"  from bpartner bp left join bp_client c on bp.id = c.bpartner_id"+" where c.client_id = :p_client_id"+"   and c.is_customer = 'Y') tsql " + this.queryWhere.toString() + " " + this.queryOrderBy;
