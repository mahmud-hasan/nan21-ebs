...
public class LOV0046 extends AbstractDataControl implements IDataControlLov {
...
private void preQuery() {
  ...
  public void doQuery() throws Exception {
      ...
      String sql = "select tsql.* from (select m.id , m.name from mm_prod_attr_grp m) tsql " + this.queryWhere.toString() + " " + this.queryOrderBy;
