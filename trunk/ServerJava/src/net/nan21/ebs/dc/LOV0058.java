...
public class LOV0058 extends AbstractDataControl implements IDataControlLov {
...
private void preQuery() {
  ...
  public void doQuery() throws Exception {
      ...
      String sql = "select tsql.* from (select code from tr_transport_type order by 1) tsql " + this.queryWhere.toString() + " " + this.queryOrderBy;
