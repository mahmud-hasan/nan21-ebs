...
public void doQuery() throws Exception {
    ...
    String sql = "select "+ 
               ...
               " ,to_char(t.EFECTIVE_ARRIVE_DATE,'"+this.DATE_FORMAT_DB+"') EFECTIVE_ARRIVE_DATE"+
               " ,to_char(t.EFECTIVE_DEP_DATE,'"+this.DATE_FORMAT_DB+"') EFECTIVE_DEP_DATE"+
               " ,t.ID"+
               " ,t.MODIFIEDBY"+
               " ,to_char(t.MODIFIEDON,'"+this.DATE_FORMAT_DB+"') MODIFIEDON"+
               " ,to_char(t.PLANNED_ARRIVE_DATE,'"+this.DATE_FORMAT_DB+"') PLANNED_ARRIVE_DATE"+
               " ,to_char(t.PLANNED_DEP_DATE,'"+this.DATE_FORMAT_DB+"') PLANNED_DEP_DATE"+
               " ,t.TRANSPSTAT_CODE"+
               " ,t.TRANSPTYPE_CODE"+
               " ,t.VEHICLE_ID"+
