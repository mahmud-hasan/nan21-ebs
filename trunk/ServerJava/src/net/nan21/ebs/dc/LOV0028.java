...
public class LOV0028 extends AbstractDataControl implements IDataControlLov {
...
private void preQuery() {
  ...
  public void doQuery() throws Exception {
      ...
      String sql = "select tsql.* from (select code, name from ui_dc) tsql " + this.queryWhere.toString() + " " + this.queryOrderBy;
