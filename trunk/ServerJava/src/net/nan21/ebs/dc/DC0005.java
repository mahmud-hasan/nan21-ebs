...
private void preQuery() {
    ...
    if (this.request.getParam("QRY_SWIFTCODE") != null && !this.request.getParam("QRY_SWIFTCODE").equals("")) {
      this.queryWhere.append(( this.queryWhere.length() > 0 )?" and ":"");
      this.queryWhere.append("SWIFTCODE like :SWIFTCODE");
      this.queryParams.put("SWIFTCODE",(String)this.request.getParam("QRY_SWIFTCODE"));
    }
}
