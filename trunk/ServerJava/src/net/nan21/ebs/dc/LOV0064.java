...
public class LOV0064 extends AbstractDataControl implements IDataControlLov {
...
private void preQuery() {
  ...
  public void doQuery() throws Exception {
      ...
      String sql = "select tsql.* from (select id, name from bpartner  where id = (select c.bpartner_id from client c where c.id = :p_client_id )) tsql " + this.queryWhere.toString() + " " + this.queryOrderBy;
