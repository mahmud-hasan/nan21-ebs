...
public class LOV0070 extends AbstractDataControl implements IDataControlLov {
...
private void preQuery() {
  ...
  public void doQuery() throws Exception {
      ...
      String sql = "select tsql.* from (select id, name from TR_PARCEL_EVENT_TYPE order by 2) tsql " + this.queryWhere.toString() + " " + this.queryOrderBy;
