...
public class LOV0018 extends AbstractDataControl implements IDataControlLov {
...
private void preQuery() {
  ...
  public void doQuery() throws Exception {
      ...
      String sql = "select tsql.* from (select code, name from contract_type where active='Y') tsql " + this.queryWhere.toString() + " " + this.queryOrderBy;
