...
public class LOV0069 extends AbstractDataControl implements IDataControlLov {
...
private void preQuery() {
  ...
  public void doQuery() throws Exception {
      ...
      String sql = "select tsql.* from (select code from TR_PARCEL_EVENT_TYPE_GRP order by 1) tsql " + this.queryWhere.toString() + " " + this.queryOrderBy;
