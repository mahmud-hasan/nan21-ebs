...
<xsl:variable name="groupByColumn" select="/reportData/groupBy"/>
 ...
 <xsl:variable name="reportWidth">
  <xsl:if test="//reportData/@layout='Landscape'">890</xsl:if>
  <xsl:if test="//reportData/@layout!='Landscape'">670</xsl:if>
 </xsl:variable>
 ...
 <!--
  ...
  <xsl:if test="//reportData/@layout='Landscape'">
    <xsl:variable name="reportWidth" select="'890'"/>    // 670, 890
  </xsl:if>
  <xsl:if test="//reportData/@layout!='Landscape'">
