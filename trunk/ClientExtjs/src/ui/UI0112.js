  ...
  DC0114 = new N21.DataComp.DC0114({id:"DC0114", autoScroll:true });
  var gui = new Ext.Viewport({
    ...
    ,{ region: "north",border: false, html:"<div class='gui_title'>"+(N21.DataComp.DC0114.prototype.resourceBundle.DcProperty.Title||"Parcel events")+" &nbsp;&nbsp;&nbsp;<font size=-2>&lt;UI0112&gt;</div>"}
   ]
});
gui.findById("DC0114").executeQuery();
  });
