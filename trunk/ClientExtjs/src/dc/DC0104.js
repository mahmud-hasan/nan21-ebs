 ...
 * Generated content.
 * DC0104 DataControl: Product client list
 */

  Ext.ns("N21.DataComp");
  N21.DataComp.DC0104 = Ext.extend(N21.Base.GridEdit, {
     dataRecordMeta:    Ext.data.Record.create([
         ...
         ,{name:"PRODCLASS_CODE", type:"string" }
    ...
    ,initComponent:function() {
       Ext.apply(this, {
           store: new Ext.data.JsonStore({
              ...
              ,root:"records"
              ,url:CFG_BACKENDSERVER_URL+"?_p_action=fetch&_p_data_format=json&_p_form=DC0104"
              ,remoteSort :true
...
,"->","<span class='dcName'>DC0104</span>"          )
          ,dataComponentName:"DC0104"
          ,frame:true
          ,queryArraySize:-1
        });
         ...
         this.columnMap.add("CLIENT_CODE",{ id:'CLIENT_CODE',header:this.resourceBundle.FieldLabel.CLIENT_CODE||"Client",width:120,dataIndex:'CLIENT_CODE',insert_allowed:true,update_allowed:false,sortable:true,editor:new N21.DataComp.LOV0008({allowBlank: false,callFromGrid:this,fieldMapping: [{column:"ID",field:"CLIENT_ID"}],cls:"x-form-text-in-grid",selectOnFocus:true,displayColumn:"CODE"})});
         ...
         this.columnMap.add("FOR_SALE",{ id:'FOR_SALE',header:this.resourceBundle.FieldLabel.FOR_SALE||"For sale",width:50,dataIndex:'FOR_SALE',insert_allowed:true,update_allowed:true,sortable:true,editor:new Ext.form.ComboBox({ store:["N","Y"],selectOnFocus:true,allowBlank: false,cls:"x-form-text-in-grid"})});
         this.columnMap.add("PRODCLASS_CODE",{ id:'PRODCLASS_CODE',header:this.resourceBundle.FieldLabel.PRODCLASS_CODE||"Product class",width:100,dataIndex:'PRODCLASS_CODE',insert_allowed:true,update_allowed:true,hidden:true,sortable:true,editor:new Ext.form.TextField({selectOnFocus:true,allowBlank: true,cls:"x-form-text-in-grid"})});
    ...
    this.colModel = new Ext.grid.ColumnModel (this.columnMap.getRange());
       ...
       this.queryFields.add("ID",new Ext.form.Hidden({name:"QRY_ID",id:"DC0104F_QRY_ID",fieldLabel: this.resourceBundle.FieldLabel.ID||"ID",allowBlank:true,width:100}));
       this.queryFields.add("PRODUCT_ID",new Ext.form.Hidden({name:"QRY_PRODUCT_ID",id:"DC0104F_QRY_PRODUCT_ID",fieldLabel: this.resourceBundle.FieldLabel.PRODUCT_ID||"Product ID",allowBlank:true,width:100}));
       this.queryFields.add("CLIENT_ID",new Ext.form.Hidden({name:"QRY_CLIENT_ID",id:"DC0104F_QRY_CLIENT_ID",fieldLabel: this.resourceBundle.FieldLabel.CLIENT_ID||"Client ID",allowBlank:true,width:100}));



       this.queryFieldsVisible = [  ];
       N21.DataComp.DC0104.superclass.initComponent.apply(this, arguments);
     }

    ,onRender:function() {
       N21.DataComp.DC0104.superclass.onRender.apply(this, arguments);
     }
  ...
  Ext.reg("DC0104", N21.DataComp.DC0104);
