 ...
 */ 
  ...
  N21.DataComp.DC0103G = Ext.extend(N21.Base.GridView, {
    ...
    ,initComponent:function() {
       ...
       this.queryFields.add("IS_CUSTOMER",new Ext.form.ComboBox({name:"QRY_IS_CUSTOMER",id:"DC0103F_QRY_IS_CUSTOMER",fieldLabel: this.resourceBundle.FieldLabel.IS_CUSTOMER||"Customer?",allowBlank:true,width:50,store:["%","Y","N"],value:"%"}));
       this.queryFields.add("IS_VENDOR",new Ext.form.ComboBox({name:"QRY_IS_VENDOR",id:"DC0103F_QRY_IS_VENDOR",fieldLabel: this.resourceBundle.FieldLabel.IS_VENDOR||"Vendor?",allowBlank:true,width:50,store:["%","Y","N"],value:"%"}));
       ...
       Ext.apply(this, {
           store: new Ext.data.JsonStore({
              ...
              ,root:"records"
              ,url:CFG_BACKENDSERVER_URL+"?_p_action=fetch&_p_data_format=json&_p_form=DC0103"
              ,remoteSort :true
 ...
 */ 
  ...
  N21.DataComp.DC0103F = Ext.extend(N21.Base.EditForm, {
    ...
    ,initComponent:function() {
       ...
       this.fields.add("IS_CUSTOMER",new Ext.ux.form.XCheckbox({name:"IS_CUSTOMER",id:"DC0103F_IS_CUSTOMER",dataIndex:"IS_CUSTOMER",fieldLabel: this.resourceBundle.FieldLabel.IS_CUSTOMER||"Customer?",allowBlank:false,labelSeparator:":*",insert_allowed:true,update_allowed:true}));
       this.fields.add("IS_VENDOR",new Ext.ux.form.XCheckbox({name:"IS_VENDOR",id:"DC0103F_IS_VENDOR",dataIndex:"IS_VENDOR",fieldLabel: this.resourceBundle.FieldLabel.IS_VENDOR||"Vendor?",allowBlank:false,labelSeparator:":*",insert_allowed:true,update_allowed:true}));
       this.fields.add("IS_EMPLOYEE",new Ext.ux.form.XCheckbox({name:"IS_EMPLOYEE",id:"DC0103F_IS_EMPLOYEE",dataIndex:"IS_EMPLOYEE",fieldLabel: this.resourceBundle.FieldLabel.IS_EMPLOYEE||"Employee?",allowBlank:false,labelSeparator:":*",insert_allowed:true,update_allowed:true}));
  ...
  N21.DataComp.DC0103 = Ext.extend(N21.Base.GridEditForm, {
     ...
     initComponent:function() {
       Ext.apply(this, {
          ...
          ,border: false
          ,items: [
              {xtype: "DC0103G",id: "DC0103G",region:"west"  ,split:true,width:500,minWidth:0}
