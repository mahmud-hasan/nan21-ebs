 ...
 * Generated content.
 * DC0052 DataControl: Project issue types def.
 */

  Ext.ns("N21.DataComp");
  N21.DataComp.DC0052 = Ext.extend(N21.Base.GridEdit, {
    ...
    ,initComponent:function() {
       Ext.apply(this, {
           store: new Ext.data.JsonStore({
              ...
              ,root:"records"
              ,url:CFG_BACKENDSERVER_URL+"?_p_action=fetch&_p_data_format=json&_p_form=DC0052"
              ,remoteSort :true
...
,"->","<span class='dcName'>DC0052</span>"          )
    ...
    this.colModel = new Ext.grid.ColumnModel (this.columnMap.getRange());
       ...
       this.queryFields.add("ID",new Ext.form.Hidden({name:"QRY_ID",id:"DC0052F_QRY_ID",fieldLabel: this.resourceBundle.FieldLabel.ID||"Id",allowBlank:true,width:100}));
       this.queryFields.add("CODE",new Ext.form.TextField({name:"QRY_CODE",id:"DC0052F_QRY_CODE",fieldLabel: this.resourceBundle.FieldLabel.CODE||"Code",allowBlank:true,width:100}));
       this.queryFields.add("NAME",new Ext.form.TextField({name:"QRY_NAME",id:"DC0052F_QRY_NAME",fieldLabel: this.resourceBundle.FieldLabel.NAME||"Name",allowBlank:true,width:100}));
    ...
    ,onRender:function() {
       N21.DataComp.DC0052.superclass.onRender.apply(this, arguments);
     }
