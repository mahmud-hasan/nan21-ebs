    ...
    ,initComponent:function() {
       Ext.apply(this, {
           store: new Ext.data.JsonStore({
              ...
              ,root:"records"
              ,url:CFG_BACKENDSERVER_URL+"?_p_action=fetch&_p_data_format=json&_p_form=DC0037"
              ,remoteSort :true
...
,"->","<span class='dcName'>DC0037</span>"          )
         ...
         this.columnMap.add("LANGUAGE_CODE",{ id:'LANGUAGE_CODE',header:this.resourceBundle.FieldLabel.LANGUAGE_CODE||"Language",width:100,dataIndex:'LANGUAGE_CODE',insert_allowed:true,update_allowed:false,sortable:true});
    ...
    this.colModel = new Ext.grid.ColumnModel (this.columnMap.getRange());
       ...
       this.queryFields.add("LANGUAGE_CODE",new  N21.DataComp.LOV0044({name:"QRY_LANGUAGE_CODE",id:"DC0037F_QRY_LANGUAGE_CODE",fieldLabel: this.resourceBundle.FieldLabel.LANGUAGE_CODE||"Language",allowBlank:true,width:100,listWidth:118,selectOnFocus:true,fieldMapping: [{column:"CODE",field:"DC0037F_QRY_LANGUAGE_CODE"}]}));
