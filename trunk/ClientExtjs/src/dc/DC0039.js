 ...
 */ 
  ...
  N21.DataComp.DC0039G = Ext.extend(N21.Base.GridView, {
    ...
    ,initComponent:function() {
       ...
       this.queryFields.add("CODE",new Ext.form.TextField({name:"QRY_CODE",id:"DC0039F_QRY_CODE",fieldLabel: this.resourceBundle.FieldLabel.CODE||"Code",allowBlank:true,caseRestriction:"Upper",style: "text-transform:uppercase;",width:100}));
       ...
       this.queryFields.add("SUMMARY",new Ext.form.ComboBox({name:"QRY_SUMMARY",id:"DC0039F_QRY_SUMMARY",fieldLabel: this.resourceBundle.FieldLabel.SUMMARY||"Summary",allowBlank:true,width:40,store:["%","Y","N"],value:"%"}));
       ...
       Ext.apply(this, {
           store: new Ext.data.JsonStore({
              ...
              ,root:"records"
              ,url:CFG_BACKENDSERVER_URL+"?_p_action=fetch&_p_data_format=json&_p_form=DC0039"
              ,remoteSort :true
          ...
          ,columns: [new Ext.grid.RowNumberer(),
              ...
              ,{ id:"NAME",header:this.resourceBundle.FieldLabel.NAME||"Name",width:300,dataIndex:'NAME',sortable:true}
 ...
 */ 
  ...
  N21.DataComp.DC0039F = Ext.extend(N21.Base.EditForm, {
    ...
    ,initComponent:function() {
       ...
       this.fields.add("CODE",new Ext.form.TextField({name:"CODE",id:"DC0039F_CODE",dataIndex:"CODE",fieldLabel: this.resourceBundle.FieldLabel.CODE||"Code",allowBlank:false,labelSeparator:":*",caseRestriction:"Upper",width:150,insert_allowed:true,update_allowed:true,style: "text-transform:uppercase;"}));
       ...
       this.fields.add("STORABLE",new Ext.ux.form.XCheckbox({name:"STORABLE",id:"DC0039F_STORABLE",dataIndex:"STORABLE",fieldLabel: this.resourceBundle.FieldLabel.STORABLE||"Storable",allowBlank:true,insert_allowed:true,update_allowed:true}));
       ...
       this.fields.add("SUMMARY",new Ext.ux.form.XCheckbox({name:"SUMMARY",id:"DC0039F_SUMMARY",dataIndex:"SUMMARY",fieldLabel: this.resourceBundle.FieldLabel.SUMMARY||"Summary",allowBlank:true,insert_allowed:true,update_allowed:true}));
