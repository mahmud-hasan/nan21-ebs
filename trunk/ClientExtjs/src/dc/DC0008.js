    ...
    ,initComponent:function() {
       Ext.apply(this, {
           store: new Ext.data.JsonStore({
              ...
              ,root:"records"
              ,url:CFG_BACKENDSERVER_URL+"?_p_action=fetch&_p_data_format=json&_p_form=DC0008"
              ,remoteSort :true
...
,"->","<span class='dcName'>DC0008</span>"          )
    ...
    this.colModel = new Ext.grid.ColumnModel (this.columnMap.getRange());
       ...
       this.queryFields.add("COUNTRY_CODE",new  N21.DataComp.LOV0006({name:"QRY_COUNTRY_CODE",id:"DC0008F_QRY_COUNTRY_CODE",fieldLabel: this.resourceBundle.FieldLabel.COUNTRY_CODE||"Country",allowBlank:true,caseRestriction:"Upper",style: "text-transform:uppercase;",width:100,listWidth:118,selectOnFocus:true}));
       this.queryFields.add("CODE",new Ext.form.TextField({name:"QRY_CODE",id:"DC0008F_QRY_CODE",fieldLabel: this.resourceBundle.FieldLabel.CODE||"Code",allowBlank:true,caseRestriction:"Upper",style: "text-transform:uppercase;",width:100}));
       ...
       this.queryFields.add("ACTIVE",new Ext.form.ComboBox({name:"QRY_ACTIVE",id:"DC0008F_QRY_ACTIVE",fieldLabel: this.resourceBundle.FieldLabel.ACTIVE||"Active",allowBlank:true,width:40,listWidth:58,selectOnFocus:true,store:["%","Y","N"],value:"%"}));
