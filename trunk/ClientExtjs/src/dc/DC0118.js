 ...
 * Generated content.
 * DC0118 DataControl: Import strategy groups
 */

  Ext.ns("N21.DataComp");
  N21.DataComp.DC0118 = Ext.extend(N21.Base.GridEdit, {
    ...
    ,initComponent:function() {
       Ext.apply(this, {
           store: new Ext.data.JsonStore({
              ...
              ,url:buildBaseUrlFetch("DC0118", _n21["DATA_FORMAT_JSON"])
              ,remoteSort :true
...
,"->","<span class='dcName'>DC0118</span>"          )
          ,dataComponentName:"DC0118"
          ,frame:true
          ,queryArraySize:20
        });
    ...
    this.colModel = new Ext.grid.ColumnModel (this.columnMap.getRange());
       ...
       this.queryFields.add("ID",new Ext.form.Hidden({name:"QRY_ID",id:"DC0118F_QRY_ID",fieldLabel: this.resourceBundle.FieldLabel.ID||"Id",allowBlank:true,width:100}));
       this.queryFields.add("NAME",new Ext.form.TextField({name:"QRY_NAME",id:"DC0118F_QRY_NAME",fieldLabel: this.resourceBundle.FieldLabel.NAME||"Name",allowBlank:true,width:100}));
       this.queryFields.add("ACTIVE",new Ext.form.ComboBox({name:"QRY_ACTIVE",id:"DC0118F_QRY_ACTIVE",fieldLabel: this.resourceBundle.FieldLabel.ACTIVE||"Active",allowBlank:true,width:50,store:["%","Y","N"],value:"%"}));



       this.queryFieldsVisible = [  "NAME","ACTIVE" ];
       N21.DataComp.DC0118.superclass.initComponent.apply(this, arguments);
     }

    ,onRender:function() {
       N21.DataComp.DC0118.superclass.onRender.apply(this, arguments);
     }
  ...
  Ext.reg("DC0118", N21.DataComp.DC0118);
