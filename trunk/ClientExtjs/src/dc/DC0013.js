    ...
    ,initComponent:function() {
       Ext.apply(this, {
           store: new Ext.data.JsonStore({
              ...
              ,root:"records"
              ,url:CFG_BACKENDSERVER_URL+"?_p_action=fetch&_p_data_format=json&_p_form=DC0013"
              ,remoteSort :true
...
,"->","<span class='dcName'>DC0013</span>"          )
    ...
    this.colModel = new Ext.grid.ColumnModel (this.columnMap.getRange());
       ...
       this.queryFields.add("ACTIVE",new Ext.form.ComboBox({name:"QRY_ACTIVE",id:"DC0013F_QRY_ACTIVE",fieldLabel: this.resourceBundle.FieldLabel.ACTIVE||"Active",allowBlank:true,width:40,store:["%","Y","N"],value:"%"}));
