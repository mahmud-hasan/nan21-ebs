 ...
 */ 
  ...
  N21.DataComp.DC0061G = Ext.extend(N21.Base.GridView, {
    ...
    ,initComponent:function() {
       ...
       this.queryFields.add("IS_ACTIVE",new Ext.form.ComboBox({name:"QRY_IS_ACTIVE",id:"DC0061F_QRY_IS_ACTIVE",fieldLabel: this.resourceBundle.FieldLabel.IS_ACTIVE||"Active",allowBlank:true,width:50,store:["%","Y","N"],value:"%"}));
       this.queryFields.add("IS_DEPRECIATED",new Ext.form.ComboBox({name:"QRY_IS_DEPRECIATED",id:"DC0061F_QRY_IS_DEPRECIATED",fieldLabel: this.resourceBundle.FieldLabel.IS_DEPRECIATED||"Depreciated",allowBlank:true,width:50,store:["%","Y","N"],value:"%"}));
       this.queryFields.add("IS_DISPOSED",new Ext.form.ComboBox({name:"QRY_IS_DISPOSED",id:"DC0061F_QRY_IS_DISPOSED",fieldLabel: this.resourceBundle.FieldLabel.IS_DISPOSED||"Disposed",allowBlank:true,width:50,store:["%","Y","N"],value:"%"}));
       this.queryFields.add("IS_OWNED",new Ext.form.ComboBox({name:"QRY_IS_OWNED",id:"DC0061F_QRY_IS_OWNED",fieldLabel: this.resourceBundle.FieldLabel.IS_OWNED||"Owned",allowBlank:true,width:50,store:["%","Y","N"],value:"%"}));
       this.queryFields.add("IS_INPOSESSION",new Ext.form.ComboBox({name:"QRY_IS_INPOSESSION",id:"DC0061F_QRY_IS_INPOSESSION",fieldLabel: this.resourceBundle.FieldLabel.IS_INPOSESSION||"In-posession",allowBlank:true,width:50,store:["%","Y","N"],value:"%"}));
       this.queryFields.add("WITH_DEPRECIATION",new Ext.form.ComboBox({name:"QRY_WITH_DEPRECIATION",id:"DC0061F_QRY_WITH_DEPRECIATION",fieldLabel: this.resourceBundle.FieldLabel.WITH_DEPRECIATION||"With_depreciation",allowBlank:true,width:50,store:["%","Y","N"],value:"%"}));
       ...
       Ext.apply(this, {
           store: new Ext.data.JsonStore({
              ...
              ,root:"records"
              ,url:CFG_BACKENDSERVER_URL+"?_p_action=fetch&_p_data_format=json&_p_form=DC0061"
              ,remoteSort :true
 ...
 */ 
  ...
  N21.DataComp.DC0061F = Ext.extend(N21.Base.EditForm, {
    ...
    ,initComponent:function() {
       ...
       this.fields.add("IS_ACTIVE",new Ext.ux.form.XCheckbox({name:"IS_ACTIVE",id:"DC0061F_IS_ACTIVE",dataIndex:"IS_ACTIVE",fieldLabel: this.resourceBundle.FieldLabel.IS_ACTIVE||"Active",allowBlank:true,insert_allowed:true,update_allowed:true}));
       this.fields.add("IS_DEPRECIATED",new Ext.ux.form.XCheckbox({name:"IS_DEPRECIATED",id:"DC0061F_IS_DEPRECIATED",dataIndex:"IS_DEPRECIATED",fieldLabel: this.resourceBundle.FieldLabel.IS_DEPRECIATED||"Depreciated",allowBlank:true,insert_allowed:true,update_allowed:true}));
       this.fields.add("IS_DISPOSED",new Ext.ux.form.XCheckbox({name:"IS_DISPOSED",id:"DC0061F_IS_DISPOSED",dataIndex:"IS_DISPOSED",fieldLabel: this.resourceBundle.FieldLabel.IS_DISPOSED||"Disposed",allowBlank:true,insert_allowed:true,update_allowed:true}));
       this.fields.add("IS_OWNED",new Ext.ux.form.XCheckbox({name:"IS_OWNED",id:"DC0061F_IS_OWNED",dataIndex:"IS_OWNED",fieldLabel: this.resourceBundle.FieldLabel.IS_OWNED||"Owned",allowBlank:true,insert_allowed:true,update_allowed:true}));
       this.fields.add("IS_INPOSESSION",new Ext.ux.form.XCheckbox({name:"IS_INPOSESSION",id:"DC0061F_IS_INPOSESSION",dataIndex:"IS_INPOSESSION",fieldLabel: this.resourceBundle.FieldLabel.IS_INPOSESSION||"In-posession",allowBlank:true,insert_allowed:true,update_allowed:true}));
       ...
       this.fields.add("WITH_DEPRECIATION",new Ext.ux.form.XCheckbox({name:"WITH_DEPRECIATION",id:"DC0061F_WITH_DEPRECIATION",dataIndex:"WITH_DEPRECIATION",fieldLabel: this.resourceBundle.FieldLabel.WITH_DEPRECIATION||"With_depreciation",allowBlank:true,insert_allowed:true,update_allowed:true}));
       ...
       this.fields.add("CREATEDON",new Ext.form.DateField({name:"CREATEDON",id:"DC0061F_CREATEDON",dataIndex:"CREATEDON",fieldLabel: this.resourceBundle.FieldLabel.CREATEDON||"Created on",allowBlank:true,width:100,disabled:true,format:Ext.DATE_FORMAT}));
       ...
       this.fields.add("MODIFIEDON",new Ext.form.DateField({name:"MODIFIEDON",id:"DC0061F_MODIFIEDON",dataIndex:"MODIFIEDON",fieldLabel: this.resourceBundle.FieldLabel.MODIFIEDON||"Modified on",allowBlank:true,width:100,disabled:true,format:Ext.DATE_FORMAT}));
       ...
       this.layoutItems.add("Depreciation",
             { xtype:"fieldset", autoHeight:true,collapsible: true,title:this.resourceBundle.FieldsetTitle.Depreciation||"Depreciation",border:true,labelWidth:80,labelAlign:"left",width:"250"   ,items:[ this.fields.get("WITH_DEPRECIATION"),this.fields.get("DEPREC_MONTHS"),this.fields.get("DEPREC_BASE_VALUE"),this.fields.get("DEPREC_MONTHS_REMAINED")] });
       ...
       this.layoutItems.add("Status",
             { xtype:"fieldset", autoHeight:true,collapsible: true,title:this.resourceBundle.FieldsetTitle.Status||"Status",border:true,labelWidth:80,labelAlign:"left",width:"300"   ,items:[ this.fields.get("IS_ACTIVE"),this.fields.get("IS_DEPRECIATED"),this.fields.get("IS_DISPOSED"),this.fields.get("IS_OWNED"),this.fields.get("IS_INPOSESSION")] });
       this.layoutItems.add("Header",
             { xtype:"fieldset", autoHeight:true,collapsible: true,title:this.resourceBundle.FieldsetTitle.Header||"Header",border:true,labelWidth:80,labelAlign:"left",width:"300"   ,items:[ this.fields.get("ID"),this.fields.get("CLIENT_ID"),this.fields.get("CLIORG_ID"),this.fields.get("PRODUCT_ID"),this.fields.get("ASSETGRP_ID"),this.fields.get("CLIENT_CODE"),this.fields.get("NAME"),this.fields.get("ASSETGRP_NAME"),this.fields.get("QUANTITY"),this.fields.get("SERIAL_NO"),this.fields.get("NOTES")] });
