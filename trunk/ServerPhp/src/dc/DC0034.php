...
public function fetchRecord() {
    $this->record["CODE"] = $this->getRequestParam("CODE");
    if (empty($this->record["CODE"])) { throw new Exception("Missing value for primary key field CODE in DC0034.fetchRecord().");}
...
public function doDelete() {
    $this->record["CODE"] = $this->getRequestParam("CODE");
    if (empty($this->record["CODE"])) { throw new Exception("Missing value for primary key field CODE in DC0034.doDelete().");}
...
public function initNewRecord() {
    ...
    $this->setFieldInitialValues($this->record, "DC0034");
    print "{success:true, data:".json_encode($this->record)."}";
