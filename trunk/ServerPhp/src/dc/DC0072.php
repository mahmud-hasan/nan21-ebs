...
public function fetchRecord() {
    ...
    if (empty($this->record["ID"])) { throw new Exception("Missing value for primary key field ID in DC0072.fetchRecord().");}
...
private function _initFields() {
  ...
  ,"IP_ADRESS" => array(parent::FLDPROP_DATA_TYPE => "STRING")
  ,"LOGIN" => array(parent::FLDPROP_DATA_TYPE => "DATE")
  ,"LOGOUT" => array(parent::FLDPROP_DATA_TYPE => "DATE")
